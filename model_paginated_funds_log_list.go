...
// checks if the PaginatedFundsLogList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedFundsLogList{}

// PaginatedFundsLogList struct for PaginatedFundsLogList
type PaginatedFundsLogList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []FundsLog `json:"results"`
}

type _PaginatedFundsLogList PaginatedFundsLogList
...
func (o *PaginatedFundsLogList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedFundsLogList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedFundsLogList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedFundsLogList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedFundsLogList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedFundsLogList := _PaginatedFundsLogList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedFundsLogList)

	if err != nil {
		return err
	}

	*o = PaginatedFundsLogList(varPaginatedFundsLogList)

	return err
}

type NullablePaginatedFundsLogList struct {
	value *PaginatedFundsLogList
	isSet bool
}

func (v NullablePaginatedFundsLogList) Get() *PaginatedFundsLogList {
	return v.value
}

func (v *NullablePaginatedFundsLogList) Set(val *PaginatedFundsLogList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFundsLogList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFundsLogList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFundsLogList(val *PaginatedFundsLogList) *NullablePaginatedFundsLogList {
	return &NullablePaginatedFundsLogList{value: val, isSet: true}
}

func (v NullablePaginatedFundsLogList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFundsLogList) UnmarshalJSON(src []byte) error {
	v.isSet = true
