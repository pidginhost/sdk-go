...
// checks if the PaginatedServerList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedServerList{}

// PaginatedServerList struct for PaginatedServerList
type PaginatedServerList struct {
...
type _PaginatedServerList PaginatedServerList
...
func (o *PaginatedServerList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedServerList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedServerList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedServerList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedServerList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedServerList := _PaginatedServerList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedServerList)

	if err != nil {
		return err
	}

	*o = PaginatedServerList(varPaginatedServerList)

	return err
}

type NullablePaginatedServerList struct {
	value *PaginatedServerList
	isSet bool
}

func (v NullablePaginatedServerList) Get() *PaginatedServerList {
	return v.value
}

func (v *NullablePaginatedServerList) Set(val *PaginatedServerList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedServerList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedServerList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedServerList(val *PaginatedServerList) *NullablePaginatedServerList {
	return &NullablePaginatedServerList{value: val, isSet: true}
}

func (v NullablePaginatedServerList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedServerList) UnmarshalJSON(src []byte) error {
	v.isSet = true
