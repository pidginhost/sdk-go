...
// checks if the PaginatedFloatingIPv6List type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedFloatingIPv6List{}

// PaginatedFloatingIPv6List struct for PaginatedFloatingIPv6List
type PaginatedFloatingIPv6List struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []FloatingIPv6 `json:"results"`
}

type _PaginatedFloatingIPv6List PaginatedFloatingIPv6List
...
func NewPaginatedFloatingIPv6List(count int32, results []FloatingIPv6) *PaginatedFloatingIPv6List {
	this := PaginatedFloatingIPv6List{}
	this.Count = count
...
func (o *PaginatedFloatingIPv6List) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedFloatingIPv6List) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedFloatingIPv6List) MarshalJSON() ([]byte, error) {
...
func (o PaginatedFloatingIPv6List) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedFloatingIPv6List) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedFloatingIPv6List := _PaginatedFloatingIPv6List{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedFloatingIPv6List)

	if err != nil {
		return err
	}

	*o = PaginatedFloatingIPv6List(varPaginatedFloatingIPv6List)

	return err
}

type NullablePaginatedFloatingIPv6List struct {
	value *PaginatedFloatingIPv6List
	isSet bool
}

func (v NullablePaginatedFloatingIPv6List) Get() *PaginatedFloatingIPv6List {
	return v.value
}

func (v *NullablePaginatedFloatingIPv6List) Set(val *PaginatedFloatingIPv6List) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFloatingIPv6List) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFloatingIPv6List) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFloatingIPv6List(val *PaginatedFloatingIPv6List) *NullablePaginatedFloatingIPv6List {
	return &NullablePaginatedFloatingIPv6List{value: val, isSet: true}
}

func (v NullablePaginatedFloatingIPv6List) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFloatingIPv6List) UnmarshalJSON(src []byte) error {
	v.isSet = true
