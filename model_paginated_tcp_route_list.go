...
// checks if the PaginatedTCPRouteList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedTCPRouteList{}

// PaginatedTCPRouteList struct for PaginatedTCPRouteList
type PaginatedTCPRouteList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []TCPRoute `json:"results"`
}

type _PaginatedTCPRouteList PaginatedTCPRouteList
...
func (o *PaginatedTCPRouteList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedTCPRouteList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedTCPRouteList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedTCPRouteList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedTCPRouteList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedTCPRouteList := _PaginatedTCPRouteList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedTCPRouteList)

	if err != nil {
		return err
	}

	*o = PaginatedTCPRouteList(varPaginatedTCPRouteList)

	return err
}

type NullablePaginatedTCPRouteList struct {
	value *PaginatedTCPRouteList
	isSet bool
}

func (v NullablePaginatedTCPRouteList) Get() *PaginatedTCPRouteList {
	return v.value
}

func (v *NullablePaginatedTCPRouteList) Set(val *PaginatedTCPRouteList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedTCPRouteList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedTCPRouteList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedTCPRouteList(val *PaginatedTCPRouteList) *NullablePaginatedTCPRouteList {
	return &NullablePaginatedTCPRouteList{value: val, isSet: true}
}

func (v NullablePaginatedTCPRouteList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedTCPRouteList) UnmarshalJSON(src []byte) error {
	v.isSet = true
