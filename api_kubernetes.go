...
type ApiKubernetesClustersEligibleVmsRetrieve2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	id string
}

func (r ApiKubernetesClustersEligibleVmsRetrieve2Request) Execute() (*EligibleVMsResponse, *http.Response, error) {
	return r.ApiService.KubernetesClustersEligibleVmsRetrieve2Execute(r)
}

/*
KubernetesClustersEligibleVmsRetrieve2 Method for KubernetesClustersEligibleVmsRetrieve2

List cloud VMs eligible for connection to this cluster.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiKubernetesClustersEligibleVmsRetrieve2Request
*/
func (a *KubernetesAPIService) KubernetesClustersEligibleVmsRetrieve2(ctx context.Context, id string) ApiKubernetesClustersEligibleVmsRetrieve2Request {
	return ApiKubernetesClustersEligibleVmsRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return EligibleVMsResponse
func (a *KubernetesAPIService) KubernetesClustersEligibleVmsRetrieve2Execute(r ApiKubernetesClustersEligibleVmsRetrieve2Request) (*EligibleVMsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersEligibleVmsRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{id}/eligible-vms/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiKubernetesClustersLbFirewallCreate2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	lBFirewallRule *LBFirewallRule
...
func (r ApiKubernetesClustersLbFirewallCreate2Request) LBFirewallRule(lBFirewallRule LBFirewallRule) ApiKubernetesClustersLbFirewallCreate2Request {
	r.lBFirewallRule = &lBFirewallRule
	return r
}

func (r ApiKubernetesClustersLbFirewallCreate2Request) Execute() (*LBFirewallRule, *http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallCreate2Execute(r)
}

/*
KubernetesClustersLbFirewallCreate2 Method for KubernetesClustersLbFirewallCreate2

Require complete user profile for provisioning (create) API actions.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersLbFirewallCreate2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallCreate2(ctx context.Context, clusterId int32) ApiKubernetesClustersLbFirewallCreate2Request {
	return ApiKubernetesClustersLbFirewallCreate2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return LBFirewallRule
func (a *KubernetesAPIService) KubernetesClustersLbFirewallCreate2Execute(r ApiKubernetesClustersLbFirewallCreate2Request) (*LBFirewallRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{cluster_id}/lb-firewall/"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
type ApiKubernetesClustersLbFirewallDestroy2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersLbFirewallDestroy2Request) Execute() (*http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallDestroy2Execute(r)
}

/*
KubernetesClustersLbFirewallDestroy2 Method for KubernetesClustersLbFirewallDestroy2
...
Require complete user profile for provisioning (create) API actions.
 ...
 @param clusterId
 @param id
 @return ApiKubernetesClustersLbFirewallDestroy2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallDestroy2(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersLbFirewallDestroy2Request {
	return ApiKubernetesClustersLbFirewallDestroy2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *KubernetesAPIService) KubernetesClustersLbFirewallDestroy2Execute(r ApiKubernetesClustersLbFirewallDestroy2Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallDestroy2")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{cluster_id}/lb-firewall/{id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiKubernetesClustersLbFirewallList2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	page *int32
...
// A page number within the paginated result set.
func (r ApiKubernetesClustersLbFirewallList2Request) Page(page int32) ApiKubernetesClustersLbFirewallList2Request {
	r.page = &page
	return r
}

func (r ApiKubernetesClustersLbFirewallList2Request) Execute() (*PaginatedLBFirewallRuleList, *http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallList2Execute(r)
}

/*
KubernetesClustersLbFirewallList2 Method for KubernetesClustersLbFirewallList2

Require complete user profile for provisioning (create) API actions.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersLbFirewallList2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallList2(ctx context.Context, clusterId int32) ApiKubernetesClustersLbFirewallList2Request {
	return ApiKubernetesClustersLbFirewallList2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return PaginatedLBFirewallRuleList
func (a *KubernetesAPIService) KubernetesClustersLbFirewallList2Execute(r ApiKubernetesClustersLbFirewallList2Request) (*PaginatedLBFirewallRuleList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallList2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKubernetesClustersLbFirewallPartialUpdate2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersLbFirewallPartialUpdate2Request) PatchedLBFirewallRule(patchedLBFirewallRule PatchedLBFirewallRule) ApiKubernetesClustersLbFirewallPartialUpdate2Request {
	r.patchedLBFirewallRule = &patchedLBFirewallRule
	return r
}

func (r ApiKubernetesClustersLbFirewallPartialUpdate2Request) Execute() (*LBFirewallRule, *http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallPartialUpdate2Execute(r)
}

/*
KubernetesClustersLbFirewallPartialUpdate2 Method for KubernetesClustersLbFirewallPartialUpdate2
...
Require complete user profile for provisioning (create) API actions.
 ...
 @param clusterId
 @param id
 @return ApiKubernetesClustersLbFirewallPartialUpdate2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallPartialUpdate2(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersLbFirewallPartialUpdate2Request {
	return ApiKubernetesClustersLbFirewallPartialUpdate2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return LBFirewallRule
func (a *KubernetesAPIService) KubernetesClustersLbFirewallPartialUpdate2Execute(r ApiKubernetesClustersLbFirewallPartialUpdate2Request) (*LBFirewallRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallPartialUpdate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKubernetesClustersLbFirewallRetrieve2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersLbFirewallRetrieve2Request) Execute() (*LBFirewallRule, *http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallRetrieve2Execute(r)
}

/*
KubernetesClustersLbFirewallRetrieve2 Method for KubernetesClustersLbFirewallRetrieve2
...
Require complete user profile for provisioning (create) API actions.
 ...
 @param clusterId
 @param id
 @return ApiKubernetesClustersLbFirewallRetrieve2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallRetrieve2(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersLbFirewallRetrieve2Request {
	return ApiKubernetesClustersLbFirewallRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return LBFirewallRule
func (a *KubernetesAPIService) KubernetesClustersLbFirewallRetrieve2Execute(r ApiKubernetesClustersLbFirewallRetrieve2Request) (*LBFirewallRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKubernetesClustersLbFirewallUpdate2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersLbFirewallUpdate2Request) LBFirewallRule(lBFirewallRule LBFirewallRule) ApiKubernetesClustersLbFirewallUpdate2Request {
	r.lBFirewallRule = &lBFirewallRule
	return r
}

func (r ApiKubernetesClustersLbFirewallUpdate2Request) Execute() (*LBFirewallRule, *http.Response, error) {
	return r.ApiService.KubernetesClustersLbFirewallUpdate2Execute(r)
}

/*
KubernetesClustersLbFirewallUpdate2 Method for KubernetesClustersLbFirewallUpdate2
...
Require complete user profile for provisioning (create) API actions.
 ...
 @param clusterId
 @param id
 @return ApiKubernetesClustersLbFirewallUpdate2Request
*/
func (a *KubernetesAPIService) KubernetesClustersLbFirewallUpdate2(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersLbFirewallUpdate2Request {
	return ApiKubernetesClustersLbFirewallUpdate2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return LBFirewallRule
func (a *KubernetesAPIService) KubernetesClustersLbFirewallUpdate2Execute(r ApiKubernetesClustersLbFirewallUpdate2Request) (*LBFirewallRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersLbFirewallUpdate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request) Execute() (*NodeMetricsResponse, *http.Response, error) {
	return r.ApiService.KubernetesClustersResourcePoolsNodesMetricsRetrieve2Execute(r)
}

/*
KubernetesClustersResourcePoolsNodesMetricsRetrieve2 Method for KubernetesClustersResourcePoolsNodesMetricsRetrieve2
...
Get real-time metrics for a node VM.
 ...
 @param id
 @param poolId
 @return ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request
*/
func (a *KubernetesAPIService) KubernetesClustersResourcePoolsNodesMetricsRetrieve2(ctx context.Context, clusterId int32, id string, poolId int32) ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request {
	return ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return NodeMetricsResponse
func (a *KubernetesAPIService) KubernetesClustersResourcePoolsNodesMetricsRetrieve2Execute(r ApiKubernetesClustersResourcePoolsNodesMetricsRetrieve2Request) (*NodeMetricsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersResourcePoolsNodesMetricsRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{cluster_id}/resource-pools/{pool_id}/nodes/{id}/metrics/"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pool_id"+"}", url.PathEscape(parameterValueToString(r.poolId, "poolId")), -1)
...
type ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	id string
...
func (r ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request) Execute() (*NodeRRDResponse, *http.Response, error) {
	return r.ApiService.KubernetesClustersResourcePoolsNodesRrdRetrieve2Execute(r)
}

/*
KubernetesClustersResourcePoolsNodesRrdRetrieve2 Method for KubernetesClustersResourcePoolsNodesRrdRetrieve2
...
Get RRD (historical) metrics data for a node VM.
 ...
 @param id
 @param poolId
 @return ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request
*/
func (a *KubernetesAPIService) KubernetesClustersResourcePoolsNodesRrdRetrieve2(ctx context.Context, clusterId int32, id string, poolId int32) ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request {
	return ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return NodeRRDResponse
func (a *KubernetesAPIService) KubernetesClustersResourcePoolsNodesRrdRetrieve2Execute(r ApiKubernetesClustersResourcePoolsNodesRrdRetrieve2Request) (*NodeRRDResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersResourcePoolsNodesRrdRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{cluster_id}/resource-pools/{pool_id}/nodes/{id}/rrd/"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pool_id"+"}", url.PathEscape(parameterValueToString(r.poolId, "poolId")), -1)
...
type ApiKubernetesClustersToggleCloudVmAccessCreate2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	id string
}

func (r ApiKubernetesClustersToggleCloudVmAccessCreate2Request) Execute() (*ToggleCloudVMAccessResponse, *http.Response, error) {
	return r.ApiService.KubernetesClustersToggleCloudVmAccessCreate2Execute(r)
}

/*
KubernetesClustersToggleCloudVmAccessCreate2 Method for KubernetesClustersToggleCloudVmAccessCreate2

Toggle cloud VM access for this cluster.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiKubernetesClustersToggleCloudVmAccessCreate2Request
*/
func (a *KubernetesAPIService) KubernetesClustersToggleCloudVmAccessCreate2(ctx context.Context, id string) ApiKubernetesClustersToggleCloudVmAccessCreate2Request {
	return ApiKubernetesClustersToggleCloudVmAccessCreate2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ToggleCloudVMAccessResponse
func (a *KubernetesAPIService) KubernetesClustersToggleCloudVmAccessCreate2Execute(r ApiKubernetesClustersToggleCloudVmAccessCreate2Request) (*ToggleCloudVMAccessResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersToggleCloudVmAccessCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{id}/toggle-cloud-vm-access/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiKubernetesClustersUpgradeFeatureCreate2Request struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	id string
	featureUpgradeRequest *FeatureUpgradeRequest
...
func (r ApiKubernetesClustersUpgradeFeatureCreate2Request) FeatureUpgradeRequest(featureUpgradeRequest FeatureUpgradeRequest) ApiKubernetesClustersUpgradeFeatureCreate2Request {
	r.featureUpgradeRequest = &featureUpgradeRequest
	return r
}

func (r ApiKubernetesClustersUpgradeFeatureCreate2Request) Execute() (*FeatureUpgradeResponse, *http.Response, error) {
	return r.ApiService.KubernetesClustersUpgradeFeatureCreate2Execute(r)
}

/*
KubernetesClustersUpgradeFeatureCreate2 Method for KubernetesClustersUpgradeFeatureCreate2

Upgrade a cluster feature to the latest compatible version.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiKubernetesClustersUpgradeFeatureCreate2Request
*/
func (a *KubernetesAPIService) KubernetesClustersUpgradeFeatureCreate2(ctx context.Context, id string) ApiKubernetesClustersUpgradeFeatureCreate2Request {
	return ApiKubernetesClustersUpgradeFeatureCreate2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return FeatureUpgradeResponse
func (a *KubernetesAPIService) KubernetesClustersUpgradeFeatureCreate2Execute(r ApiKubernetesClustersUpgradeFeatureCreate2Request) (*FeatureUpgradeResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersUpgradeFeatureCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/kubernetes/clusters/{id}/upgrade-feature/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
