...
type ApiKubernetesClustersHttproutesListRequest struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	page *int32
...
// A page number within the paginated result set.
func (r ApiKubernetesClustersHttproutesListRequest) Page(page int32) ApiKubernetesClustersHttproutesListRequest {
	r.page = &page
	return r
}

func (r ApiKubernetesClustersHttproutesListRequest) Execute() (*PaginatedHTTPRouteList, *http.Response, error) {
	return r.ApiService.KubernetesClustersHttproutesListExecute(r)
}

/*
KubernetesClustersHttproutesList Method for KubernetesClustersHttproutesList
...
HTTPRoutes expose HTTP/HTTPS services through the Gateway with optional automatic TLS certificate issuance.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersHttproutesListRequest
*/
func (a *KubernetesAPIService) KubernetesClustersHttproutesList(ctx context.Context, clusterId int32) ApiKubernetesClustersHttproutesListRequest {
	return ApiKubernetesClustersHttproutesListRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *KubernetesAPIService) KubernetesClustersHttproutesListExecute(r ApiKubernetesClustersHttproutesListRequest) (*PaginatedHTTPRouteList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedHTTPRouteList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersHttproutesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiKubernetesClustersHttproutesRetrieveRequest) Execute() (*HTTPRoute, *http.Response, error) {
...
*/
func (a *KubernetesAPIService) KubernetesClustersHttproutesRetrieve(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersHttproutesRetrieveRequest {
	return ApiKubernetesClustersHttproutesRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return HTTPRoute
func (a *KubernetesAPIService) KubernetesClustersHttproutesRetrieveExecute(r ApiKubernetesClustersHttproutesRetrieveRequest) (*HTTPRoute, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiKubernetesClustersPortForwardsCreateRequest) Execute() (*K8sPortForward, *http.Response, error) {
...
func (a *KubernetesAPIService) KubernetesClustersPortForwardsCreateExecute(r ApiKubernetesClustersPortForwardsCreateRequest) (*K8sPortForward, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *K8sPortForward
	)
...
type ApiKubernetesClustersPortForwardsListRequest struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	page *int32
...
// A page number within the paginated result set.
func (r ApiKubernetesClustersPortForwardsListRequest) Page(page int32) ApiKubernetesClustersPortForwardsListRequest {
	r.page = &page
	return r
}

func (r ApiKubernetesClustersPortForwardsListRequest) Execute() (*PaginatedK8sPortForwardList, *http.Response, error) {
	return r.ApiService.KubernetesClustersPortForwardsListExecute(r)
}

/*
KubernetesClustersPortForwardsList Method for KubernetesClustersPortForwardsList
...
skip enforcement — the route probes pin the denial for each route.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersPortForwardsListRequest
*/
func (a *KubernetesAPIService) KubernetesClustersPortForwardsList(ctx context.Context, clusterId int32) ApiKubernetesClustersPortForwardsListRequest {
	return ApiKubernetesClustersPortForwardsListRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *KubernetesAPIService) KubernetesClustersPortForwardsListExecute(r ApiKubernetesClustersPortForwardsListRequest) (*PaginatedK8sPortForwardList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedK8sPortForwardList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersPortForwardsList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiKubernetesClustersPortForwardsPartialUpdateRequest) Execute() (*K8sPortForward, *http.Response, error) {
...
// Execute executes the request
//  @return K8sPortForward
func (a *KubernetesAPIService) KubernetesClustersPortForwardsPartialUpdateExecute(r ApiKubernetesClustersPortForwardsPartialUpdateRequest) (*K8sPortForward, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiKubernetesClustersPortForwardsRetrieveRequest) Execute() (*K8sPortForward, *http.Response, error) {
...
*/
func (a *KubernetesAPIService) KubernetesClustersPortForwardsRetrieve(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersPortForwardsRetrieveRequest {
	return ApiKubernetesClustersPortForwardsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return K8sPortForward
func (a *KubernetesAPIService) KubernetesClustersPortForwardsRetrieveExecute(r ApiKubernetesClustersPortForwardsRetrieveRequest) (*K8sPortForward, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiKubernetesClustersPortForwardsUpdateRequest) Execute() (*K8sPortForward, *http.Response, error) {
...
// Execute executes the request
//  @return K8sPortForward
func (a *KubernetesAPIService) KubernetesClustersPortForwardsUpdateExecute(r ApiKubernetesClustersPortForwardsUpdateRequest) (*K8sPortForward, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Window of recorded data to return.
func (r ApiKubernetesClustersResourcePoolsNodesRrdRetrieveRequest) Timeframe(timeframe string) ApiKubernetesClustersResourcePoolsNodesRrdRetrieveRequest {
...
type ApiKubernetesClustersTcproutesListRequest struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	page *int32
...
// A page number within the paginated result set.
func (r ApiKubernetesClustersTcproutesListRequest) Page(page int32) ApiKubernetesClustersTcproutesListRequest {
	r.page = &page
	return r
}

func (r ApiKubernetesClustersTcproutesListRequest) Execute() (*PaginatedTCPRouteList, *http.Response, error) {
	return r.ApiService.KubernetesClustersTcproutesListExecute(r)
}

/*
KubernetesClustersTcproutesList Method for KubernetesClustersTcproutesList
...
Reserved ports (22, 6443, 50000, 50001) cannot be exposed.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersTcproutesListRequest
*/
func (a *KubernetesAPIService) KubernetesClustersTcproutesList(ctx context.Context, clusterId int32) ApiKubernetesClustersTcproutesListRequest {
	return ApiKubernetesClustersTcproutesListRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *KubernetesAPIService) KubernetesClustersTcproutesListExecute(r ApiKubernetesClustersTcproutesListRequest) (*PaginatedTCPRouteList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedTCPRouteList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersTcproutesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiKubernetesClustersTcproutesRetrieveRequest) Execute() (*TCPRoute, *http.Response, error) {
...
*/
func (a *KubernetesAPIService) KubernetesClustersTcproutesRetrieve(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersTcproutesRetrieveRequest {
	return ApiKubernetesClustersTcproutesRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return TCPRoute
func (a *KubernetesAPIService) KubernetesClustersTcproutesRetrieveExecute(r ApiKubernetesClustersTcproutesRetrieveRequest) (*TCPRoute, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiKubernetesClustersUdproutesListRequest struct {
	ctx context.Context
	ApiService *KubernetesAPIService
	clusterId int32
	page *int32
...
// A page number within the paginated result set.
func (r ApiKubernetesClustersUdproutesListRequest) Page(page int32) ApiKubernetesClustersUdproutesListRequest {
	r.page = &page
	return r
}

func (r ApiKubernetesClustersUdproutesListRequest) Execute() (*PaginatedUDPRouteList, *http.Response, error) {
	return r.ApiService.KubernetesClustersUdproutesListExecute(r)
}

/*
KubernetesClustersUdproutesList Method for KubernetesClustersUdproutesList
...
UDPRoutes expose UDP services through the Gateway on specific external ports.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clusterId
 @return ApiKubernetesClustersUdproutesListRequest
*/
func (a *KubernetesAPIService) KubernetesClustersUdproutesList(ctx context.Context, clusterId int32) ApiKubernetesClustersUdproutesListRequest {
	return ApiKubernetesClustersUdproutesListRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *KubernetesAPIService) KubernetesClustersUdproutesListExecute(r ApiKubernetesClustersUdproutesListRequest) (*PaginatedUDPRouteList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedUDPRouteList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KubernetesAPIService.KubernetesClustersUdproutesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiKubernetesClustersUdproutesRetrieveRequest) Execute() (*UDPRoute, *http.Response, error) {
...
*/
func (a *KubernetesAPIService) KubernetesClustersUdproutesRetrieve(ctx context.Context, clusterId int32, id string) ApiKubernetesClustersUdproutesRetrieveRequest {
	return ApiKubernetesClustersUdproutesRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return UDPRoute
func (a *KubernetesAPIService) KubernetesClustersUdproutesRetrieveExecute(r ApiKubernetesClustersUdproutesRetrieveRequest) (*UDPRoute, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
