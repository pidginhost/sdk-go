...
type ApiSchemaRetrieve2Request struct {
	ctx context.Context
	ApiService *SchemaAPIService
	format *string
	lang *string
...
func (r ApiSchemaRetrieve2Request) Format(format string) ApiSchemaRetrieve2Request {
	r.format = &format
	return r
}

func (r ApiSchemaRetrieve2Request) Lang(lang string) ApiSchemaRetrieve2Request {
	r.lang = &lang
	return r
}

func (r ApiSchemaRetrieve2Request) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.SchemaRetrieve2Execute(r)
}

/*
SchemaRetrieve2 Method for SchemaRetrieve2
...
- JSON: application/vnd.oai.openapi+json
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSchemaRetrieve2Request
*/
func (a *SchemaAPIService) SchemaRetrieve2(ctx context.Context) ApiSchemaRetrieve2Request {
	return ApiSchemaRetrieve2Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SchemaAPIService) SchemaRetrieve2Execute(r ApiSchemaRetrieve2Request) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SchemaAPIService.SchemaRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
