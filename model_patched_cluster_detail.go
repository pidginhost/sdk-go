...
type PatchedClusterDetail struct {
	...
	PricePerMonth *string `json:"price_per_month,omitempty" validate:"regexp=^-?\\d{0\\,16}(?:\\.\\d{0\\,4})?$"`
	...
	TalosUpgradeAvailable *bool `json:"talos_upgrade_available,omitempty"`
	TalosNextVersion *string `json:"talos_next_version,omitempty"`
	StorageQuotaGb *int32 `json:"storage_quota_gb,omitempty"`
	LastPoolUsedBytes *int64 `json:"last_pool_used_bytes,omitempty"`
	LastStorageSyncAt *string `json:"last_storage_sync_at,omitempty"`
}
...
// SetPricePerMonth gets a reference to the given string and assigns it to the PricePerMonth field.
...
// GetDualStack returns the DualStack field value if set, zero value otherwise.
func (o *PatchedClusterDetail) GetDualStack() bool {
	if o == nil || IsNil(o.DualStack) {
		var ret bool
		return ret
	}
	return *o.DualStack
...
// GetDualStackOk returns a tuple with the DualStack field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchedClusterDetail) GetDualStackOk() (*bool, bool) {
	if o == nil || IsNil(o.DualStack) {
		return nil, false
	}
	return o.DualStack, true
}
...
// SetDualStack gets a reference to the given bool and assigns it to the DualStack field.
...
// SetTalosUpgradeAvailable gets a reference to the given bool and assigns it to the TalosUpgradeAvailable field.
...
// GetStorageQuotaGb returns the StorageQuotaGb field value if set, zero value otherwise.
func (o *PatchedClusterDetail) GetStorageQuotaGb() int32 {
	if o == nil || IsNil(o.StorageQuotaGb) {
		var ret int32
		return ret
	}
...
// GetStorageQuotaGbOk returns a tuple with the StorageQuotaGb field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetStorageQuotaGb gets a reference to the given int32 and assigns it to the StorageQuotaGb field.
func (o *PatchedClusterDetail) SetStorageQuotaGb(v int32) {
	o.StorageQuotaGb = &v
}

// GetLastPoolUsedBytes returns the LastPoolUsedBytes field value if set, zero value otherwise.
func (o *PatchedClusterDetail) GetLastPoolUsedBytes() int64 {
	if o == nil || IsNil(o.LastPoolUsedBytes) {
		var ret int64
		return ret
	}
...
// GetLastPoolUsedBytesOk returns a tuple with the LastPoolUsedBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLastPoolUsedBytes gets a reference to the given int64 and assigns it to the LastPoolUsedBytes field.
func (o *PatchedClusterDetail) SetLastPoolUsedBytes(v int64) {
	o.LastPoolUsedBytes = &v
}

// GetLastStorageSyncAt returns the LastStorageSyncAt field value if set, zero value otherwise.
func (o *PatchedClusterDetail) GetLastStorageSyncAt() string {
	if o == nil || IsNil(o.LastStorageSyncAt) {
		var ret string
		return ret
	}
...
// GetLastStorageSyncAtOk returns a tuple with the LastStorageSyncAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLastStorageSyncAt gets a reference to the given string and assigns it to the LastStorageSyncAt field.
