...
type PatchedClusterDetail struct {
	...
	DualStack *string `json:"dual_stack,omitempty"`
	...
	StorageQuotaGb *string `json:"storage_quota_gb,omitempty"`
	LastPoolUsedBytes *string `json:"last_pool_used_bytes,omitempty"`
...
// SetDualStack gets a reference to the given string and assigns it to the DualStack field.
...
// SetStorageQuotaGb gets a reference to the given string and assigns it to the StorageQuotaGb field.
...
// SetLastPoolUsedBytes gets a reference to the given string and assigns it to the LastPoolUsedBytes field.
