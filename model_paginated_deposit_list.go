...
// checks if the PaginatedDepositList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedDepositList{}

// PaginatedDepositList struct for PaginatedDepositList
type PaginatedDepositList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []Deposit `json:"results"`
}

type _PaginatedDepositList PaginatedDepositList
...
func (o *PaginatedDepositList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedDepositList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedDepositList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedDepositList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedDepositList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedDepositList := _PaginatedDepositList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedDepositList)

	if err != nil {
		return err
	}

	*o = PaginatedDepositList(varPaginatedDepositList)

	return err
}

type NullablePaginatedDepositList struct {
	value *PaginatedDepositList
	isSet bool
}

func (v NullablePaginatedDepositList) Get() *PaginatedDepositList {
	return v.value
}

func (v *NullablePaginatedDepositList) Set(val *PaginatedDepositList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDepositList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedDepositList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedDepositList(val *PaginatedDepositList) *NullablePaginatedDepositList {
	return &NullablePaginatedDepositList{value: val, isSet: true}
}

func (v NullablePaginatedDepositList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedDepositList) UnmarshalJSON(src []byte) error {
	v.isSet = true
