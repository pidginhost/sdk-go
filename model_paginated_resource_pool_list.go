...
// checks if the PaginatedResourcePoolList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedResourcePoolList{}

// PaginatedResourcePoolList struct for PaginatedResourcePoolList
type PaginatedResourcePoolList struct {
...
type _PaginatedResourcePoolList PaginatedResourcePoolList
...
func NewPaginatedResourcePoolList(count int32, results []ResourcePool) *PaginatedResourcePoolList {
	this := PaginatedResourcePoolList{}
	this.Count = count
...
func (o *PaginatedResourcePoolList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedResourcePoolList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedResourcePoolList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedResourcePoolList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedResourcePoolList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedResourcePoolList := _PaginatedResourcePoolList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedResourcePoolList)

	if err != nil {
		return err
	}

	*o = PaginatedResourcePoolList(varPaginatedResourcePoolList)

	return err
}

type NullablePaginatedResourcePoolList struct {
	value *PaginatedResourcePoolList
	isSet bool
}

func (v NullablePaginatedResourcePoolList) Get() *PaginatedResourcePoolList {
	return v.value
}

func (v *NullablePaginatedResourcePoolList) Set(val *PaginatedResourcePoolList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedResourcePoolList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedResourcePoolList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedResourcePoolList(val *PaginatedResourcePoolList) *NullablePaginatedResourcePoolList {
	return &NullablePaginatedResourcePoolList{value: val, isSet: true}
}

func (v NullablePaginatedResourcePoolList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedResourcePoolList) UnmarshalJSON(src []byte) error {
	v.isSet = true
