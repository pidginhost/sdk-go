...
func Test_pidginhostsdk_SchemaAPIService(t *testing.T) {
	...
	t.Run("Test SchemaAPIService SchemaRetrieve2", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SchemaAPI.SchemaRetrieve2(context.Background()).Execute()
