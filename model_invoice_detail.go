...
type InvoiceDetail struct {
	...
	Subtotal string `json:"subtotal" validate:"regexp=^-?\\d{0\\,8}(?:\\.\\d{0\\,2})?$"`
	VatValue string `json:"vat_value" validate:"regexp=^-?\\d{0\\,8}(?:\\.\\d{0\\,2})?$"`
	VatPercentage int32 `json:"vat_percentage"`
	Total string `json:"total" validate:"regexp=^-?\\d{0\\,8}(?:\\.\\d{0\\,2})?$"`
	...
	UsageDetail interface{} `json:"usage_detail"`
...
// GetUsageDetail returns the UsageDetail field value
// If the value is explicit nil, the zero value for interface{} will be returned
...
// GetUsageDetailOk returns a tuple with the UsageDetail field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetUsageDetail sets field value
...
func (o InvoiceDetail) ToMap() (map[string]interface{}, error) {
	...
	if o.UsageDetail != nil {
		toSerialize["usage_detail"] = o.UsageDetail
	}
	if o.ClientInfo != nil {
