...
// checks if the PaginatedUDPRouteList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUDPRouteList{}

// PaginatedUDPRouteList struct for PaginatedUDPRouteList
type PaginatedUDPRouteList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []UDPRoute `json:"results"`
}

type _PaginatedUDPRouteList PaginatedUDPRouteList
...
func (o *PaginatedUDPRouteList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedUDPRouteList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedUDPRouteList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedUDPRouteList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedUDPRouteList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedUDPRouteList := _PaginatedUDPRouteList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedUDPRouteList)

	if err != nil {
		return err
	}

	*o = PaginatedUDPRouteList(varPaginatedUDPRouteList)

	return err
}

type NullablePaginatedUDPRouteList struct {
	value *PaginatedUDPRouteList
	isSet bool
}

func (v NullablePaginatedUDPRouteList) Get() *PaginatedUDPRouteList {
	return v.value
}

func (v *NullablePaginatedUDPRouteList) Set(val *PaginatedUDPRouteList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedUDPRouteList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedUDPRouteList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedUDPRouteList(val *PaginatedUDPRouteList) *NullablePaginatedUDPRouteList {
	return &NullablePaginatedUDPRouteList{value: val, isSet: true}
}

func (v NullablePaginatedUDPRouteList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedUDPRouteList) UnmarshalJSON(src []byte) error {
	v.isSet = true
