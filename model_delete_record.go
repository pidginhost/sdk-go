...
type _DeleteRecord DeleteRecord
...
func (o *DeleteRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteRecord := _DeleteRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteRecord)

	if err != nil {
		return err
	}

	*o = DeleteRecord(varDeleteRecord)
