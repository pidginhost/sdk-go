...
// checks if the PaginatedK8sPortForwardList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedK8sPortForwardList{}

// PaginatedK8sPortForwardList struct for PaginatedK8sPortForwardList
type PaginatedK8sPortForwardList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []K8sPortForward `json:"results"`
}

type _PaginatedK8sPortForwardList PaginatedK8sPortForwardList
...
func NewPaginatedK8sPortForwardList(count int32, results []K8sPortForward) *PaginatedK8sPortForwardList {
	this := PaginatedK8sPortForwardList{}
	this.Count = count
...
func (o *PaginatedK8sPortForwardList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedK8sPortForwardList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedK8sPortForwardList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedK8sPortForwardList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedK8sPortForwardList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedK8sPortForwardList := _PaginatedK8sPortForwardList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedK8sPortForwardList)

	if err != nil {
		return err
	}

	*o = PaginatedK8sPortForwardList(varPaginatedK8sPortForwardList)

	return err
}

type NullablePaginatedK8sPortForwardList struct {
	value *PaginatedK8sPortForwardList
	isSet bool
}

func (v NullablePaginatedK8sPortForwardList) Get() *PaginatedK8sPortForwardList {
	return v.value
}

func (v *NullablePaginatedK8sPortForwardList) Set(val *PaginatedK8sPortForwardList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedK8sPortForwardList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedK8sPortForwardList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedK8sPortForwardList(val *PaginatedK8sPortForwardList) *NullablePaginatedK8sPortForwardList {
	return &NullablePaginatedK8sPortForwardList{value: val, isSet: true}
}

func (v NullablePaginatedK8sPortForwardList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedK8sPortForwardList) UnmarshalJSON(src []byte) error {
	v.isSet = true
