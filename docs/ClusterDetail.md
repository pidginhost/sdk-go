...
**StorageQuotaGb** | **string** |  | [readonly] 
**LastPoolUsedBytes** | **string** |  | [readonly] 
...
`func NewClusterDetail(id int32, status ResourceStatusEnum, generation string, clusterType string, kubeVersion string, pricePerMonth string, pricePerHour string, featuresReady bool, kubeconfigValidUntil string, ipv4Address string, ipv6Address string, dualStack string, talosVersion string, talosUpgradeAvailable string, talosNextVersion string, storageQuotaGb string, lastPoolUsedBytes string, lastStorageSyncAt string, ) *ClusterDetail`
...
`func (o *ClusterDetail) GetStatus() ResourceStatusEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *ClusterDetail) GetStatusOk() (*ResourceStatusEnum, bool)`
...
`func (o *ClusterDetail) SetStatus(v ResourceStatusEnum)`
...
`func (o *ClusterDetail) GetGeneration() string`

GetGeneration returns the Generation field if non-nil, zero value otherwise.

### GetGenerationOk

`func (o *ClusterDetail) GetGenerationOk() (*string, bool)`
...
`func (o *ClusterDetail) SetGeneration(v string)`
...
`func (o *ClusterDetail) GetPricePerMonthOk() (*string, bool)`
...
`func (o *ClusterDetail) SetPricePerMonth(v string)`
...
`func (o *ClusterDetail) GetDualStack() string`

GetDualStack returns the DualStack field if non-nil, zero value otherwise.

### GetDualStackOk

`func (o *ClusterDetail) GetDualStackOk() (*string, bool)`
...
`func (o *ClusterDetail) SetDualStack(v string)`
...
`func (o *ClusterDetail) GetStorageQuotaGb() string`

GetStorageQuotaGb returns the StorageQuotaGb field if non-nil, zero value otherwise.

### GetStorageQuotaGbOk

`func (o *ClusterDetail) GetStorageQuotaGbOk() (*string, bool)`
...
`func (o *ClusterDetail) SetStorageQuotaGb(v string)`
...
`func (o *ClusterDetail) SetLastPoolUsedBytes(v string)`
