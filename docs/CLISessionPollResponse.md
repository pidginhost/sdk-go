...
**Account** | Pointer to **string** | Bound account, when the token is membership-bound | [optional] 
...
`func (o *CLISessionPollResponse) GetAccount() string`

GetAccount returns the Account field if non-nil, zero value otherwise.

### GetAccountOk

`func (o *CLISessionPollResponse) GetAccountOk() (*string, bool)`
...
`func (o *CLISessionPollResponse) SetAccount(v string)`

SetAccount sets Account field to given value.

### HasAccount

`func (o *CLISessionPollResponse) HasAccount() bool`

HasAccount returns a boolean if a field has been set.

### GetMembershipStatus

`func (o *CLISessionPollResponse) GetMembershipStatus() string`

GetMembershipStatus returns the MembershipStatus field if non-nil, zero value otherwise.

### GetMembershipStatusOk

`func (o *CLISessionPollResponse) GetMembershipStatusOk() (*string, bool)`
...
`func (o *CLISessionPollResponse) SetMembershipStatus(v string)`

SetMembershipStatus sets MembershipStatus field to given value.

### HasMembershipStatus

`func (o *CLISessionPollResponse) HasMembershipStatus() bool`
