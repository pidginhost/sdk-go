...
`func NewFundsLog(id int32, date time.Time, operation OperationEnum, amount string, balance string, forDate NullableString, ) *FundsLog`
...
`func (o *FundsLog) GetDate() time.Time`

GetDate returns the Date field if non-nil, zero value otherwise.

### GetDateOk

`func (o *FundsLog) GetDateOk() (*time.Time, bool)`
...
`func (o *FundsLog) SetDate(v time.Time)`
