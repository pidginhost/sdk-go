...
**PricePerHour** | Pointer to **float64** |  | [optional] [readonly] 
...
**Ipv6Address** | Pointer to **string** |  | [optional] [readonly] 
**DualStack** | Pointer to **bool** |  | [optional] [readonly] 
**Protected** | Pointer to **bool** |  | [optional] 
**TalosVersion** | Pointer to **string** |  | [optional] [readonly] 
**TalosUpgradeAvailable** | Pointer to **bool** |  | [optional] [readonly] 
**TalosNextVersion** | Pointer to **string** |  | [optional] [readonly] 
**StorageQuotaGb** | Pointer to **int32** |  | [optional] [readonly] 
**LastPoolUsedBytes** | Pointer to **int64** |  | [optional] [readonly] 
**LastStorageSyncAt** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *PatchedClusterDetail) GetStatus() ResourceStatusEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *PatchedClusterDetail) GetStatusOk() (*ResourceStatusEnum, bool)`
...
`func (o *PatchedClusterDetail) SetStatus(v ResourceStatusEnum)`
...
`func (o *PatchedClusterDetail) GetGeneration() string`

GetGeneration returns the Generation field if non-nil, zero value otherwise.

### GetGenerationOk

`func (o *PatchedClusterDetail) GetGenerationOk() (*string, bool)`
...
`func (o *PatchedClusterDetail) SetGeneration(v string)`

SetGeneration sets Generation field to given value.

### HasGeneration

`func (o *PatchedClusterDetail) HasGeneration() bool`
...
`func (o *PatchedClusterDetail) GetPricePerMonth() string`

GetPricePerMonth returns the PricePerMonth field if non-nil, zero value otherwise.

### GetPricePerMonthOk

`func (o *PatchedClusterDetail) GetPricePerMonthOk() (*string, bool)`
...
`func (o *PatchedClusterDetail) SetPricePerMonth(v string)`
...
`func (o *PatchedClusterDetail) GetPricePerHour() float64`

GetPricePerHour returns the PricePerHour field if non-nil, zero value otherwise.

### GetPricePerHourOk

`func (o *PatchedClusterDetail) GetPricePerHourOk() (*float64, bool)`
...
`func (o *PatchedClusterDetail) SetPricePerHour(v float64)`
...
`func (o *PatchedClusterDetail) GetIpv6Address() string`

GetIpv6Address returns the Ipv6Address field if non-nil, zero value otherwise.

### GetIpv6AddressOk

`func (o *PatchedClusterDetail) GetIpv6AddressOk() (*string, bool)`
...
`func (o *PatchedClusterDetail) SetIpv6Address(v string)`

SetIpv6Address sets Ipv6Address field to given value.

### HasIpv6Address

`func (o *PatchedClusterDetail) HasIpv6Address() bool`

HasIpv6Address returns a boolean if a field has been set.

### GetDualStack

`func (o *PatchedClusterDetail) GetDualStack() bool`

GetDualStack returns the DualStack field if non-nil, zero value otherwise.

### GetDualStackOk

`func (o *PatchedClusterDetail) GetDualStackOk() (*bool, bool)`
...
`func (o *PatchedClusterDetail) SetDualStack(v bool)`

SetDualStack sets DualStack field to given value.

### HasDualStack

`func (o *PatchedClusterDetail) HasDualStack() bool`
...
`func (o *PatchedClusterDetail) GetTalosUpgradeAvailable() bool`
...
`func (o *PatchedClusterDetail) GetTalosUpgradeAvailableOk() (*bool, bool)`
...
`func (o *PatchedClusterDetail) SetTalosUpgradeAvailable(v bool)`
...
`func (o *PatchedClusterDetail) GetStorageQuotaGb() int32`

GetStorageQuotaGb returns the StorageQuotaGb field if non-nil, zero value otherwise.

### GetStorageQuotaGbOk

`func (o *PatchedClusterDetail) GetStorageQuotaGbOk() (*int32, bool)`

GetStorageQuotaGbOk returns a tuple with the StorageQuotaGb field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetStorageQuotaGb

`func (o *PatchedClusterDetail) SetStorageQuotaGb(v int32)`

SetStorageQuotaGb sets StorageQuotaGb field to given value.

### HasStorageQuotaGb

`func (o *PatchedClusterDetail) HasStorageQuotaGb() bool`

HasStorageQuotaGb returns a boolean if a field has been set.

### GetLastPoolUsedBytes

`func (o *PatchedClusterDetail) GetLastPoolUsedBytes() int64`

GetLastPoolUsedBytes returns the LastPoolUsedBytes field if non-nil, zero value otherwise.

### GetLastPoolUsedBytesOk

`func (o *PatchedClusterDetail) GetLastPoolUsedBytesOk() (*int64, bool)`

GetLastPoolUsedBytesOk returns a tuple with the LastPoolUsedBytes field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLastPoolUsedBytes

`func (o *PatchedClusterDetail) SetLastPoolUsedBytes(v int64)`

SetLastPoolUsedBytes sets LastPoolUsedBytes field to given value.

### HasLastPoolUsedBytes

`func (o *PatchedClusterDetail) HasLastPoolUsedBytes() bool`

HasLastPoolUsedBytes returns a boolean if a field has been set.

### GetLastStorageSyncAt

`func (o *PatchedClusterDetail) GetLastStorageSyncAt() string`

GetLastStorageSyncAt returns the LastStorageSyncAt field if non-nil, zero value otherwise.

### GetLastStorageSyncAtOk

`func (o *PatchedClusterDetail) GetLastStorageSyncAtOk() (*string, bool)`

GetLastStorageSyncAtOk returns a tuple with the LastStorageSyncAt field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLastStorageSyncAt

`func (o *PatchedClusterDetail) SetLastStorageSyncAt(v string)`

SetLastStorageSyncAt sets LastStorageSyncAt field to given value.

### HasLastStorageSyncAt

`func (o *PatchedClusterDetail) HasLastStorageSyncAt() bool`

HasLastStorageSyncAt returns a boolean if a field has been set.
