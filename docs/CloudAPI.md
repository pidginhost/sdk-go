...
[**CloudFloatingIpv4AuthorizationsRetrieve**](CloudAPI.md#CloudFloatingIpv4AuthorizationsRetrieve) | **Get** /api/cloud/floating-ipv4/{id}/authorizations/ | 
...
[**CloudFloatingIpv6AuthorizationsRetrieve**](CloudAPI.md#CloudFloatingIpv6AuthorizationsRetrieve) | **Get** /api/cloud/floating-ipv6/{id}/authorizations/ | 
...
> FloatingIPv4 CloudFloatingIpv4AuthorizationsRetrieve(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudFloatingIpv4AuthorizationsRetrieve(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudFloatingIpv4AuthorizationsRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudFloatingIpv4AuthorizationsRetrieve`: FloatingIPv4
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudFloatingIpv4AuthorizationsRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudFloatingIpv4AuthorizationsRetrieveRequest struct via the builder pattern
...
> FloatingIPv6 CloudFloatingIpv6AuthorizationsRetrieve(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudFloatingIpv6AuthorizationsRetrieve(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudFloatingIpv6AuthorizationsRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudFloatingIpv6AuthorizationsRetrieve`: FloatingIPv6
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudFloatingIpv6AuthorizationsRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudFloatingIpv6AuthorizationsRetrieveRequest struct via the builder pattern
