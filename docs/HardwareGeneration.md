...
**PriceMultiplier** | Pointer to **string** | Multiplier applied to base MeteredProduct price (1.00 &#x3D; no change, 1.50 &#x3D; +50%) | [optional] 
...
**DedicatedCpu** | Pointer to **bool** | vCPUs on this generation&#39;s nodes are allocated 1:1 to host threads (no overcommit) | [optional] 
...
`func (o *HardwareGeneration) GetPriceMultiplier() string`

GetPriceMultiplier returns the PriceMultiplier field if non-nil, zero value otherwise.

### GetPriceMultiplierOk

`func (o *HardwareGeneration) GetPriceMultiplierOk() (*string, bool)`
...
`func (o *HardwareGeneration) SetPriceMultiplier(v string)`
...
`func (o *HardwareGeneration) GetDedicatedCpu() bool`

GetDedicatedCpu returns the DedicatedCpu field if non-nil, zero value otherwise.

### GetDedicatedCpuOk

`func (o *HardwareGeneration) GetDedicatedCpuOk() (*bool, bool)`

GetDedicatedCpuOk returns a tuple with the DedicatedCpu field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDedicatedCpu

`func (o *HardwareGeneration) SetDedicatedCpu(v bool)`

SetDedicatedCpu sets DedicatedCpu field to given value.

### HasDedicatedCpu

`func (o *HardwareGeneration) HasDedicatedCpu() bool`

HasDedicatedCpu returns a boolean if a field has been set.
