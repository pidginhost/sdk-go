...
[**DomainDomainCancelCreate2**](DomainAPI.md#DomainDomainCancelCreate2) | **Post** /api/v1/domain/domain/{domain}/cancel/ | 
...
[**DomainDomainContactsCreate2**](DomainAPI.md#DomainDomainContactsCreate2) | **Post** /api/v1/domain/domain/{domain}/contacts/ | 
...
[**DomainDomainNameserversCreate2**](DomainAPI.md#DomainDomainNameserversCreate2) | **Post** /api/v1/domain/domain/{domain}/nameservers/ | 
...
> DomainCancelResponse DomainDomainCancelCreate2(ctx, domain).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DomainAPI.DomainDomainCancelCreate2(context.Background(), domain).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DomainAPI.DomainDomainCancelCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DomainDomainCancelCreate2`: DomainCancelResponse
	fmt.Fprintf(os.Stdout, "Response from `DomainAPI.DomainDomainCancelCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDomainDomainCancelCreate2Request struct via the builder pattern
...
> ContactsUpdateResponse DomainDomainContactsCreate2(ctx, domain).ContactsUpdate(contactsUpdate).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DomainAPI.DomainDomainContactsCreate2(context.Background(), domain).ContactsUpdate(contactsUpdate).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DomainAPI.DomainDomainContactsCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DomainDomainContactsCreate2`: ContactsUpdateResponse
	fmt.Fprintf(os.Stdout, "Response from `DomainAPI.DomainDomainContactsCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDomainDomainContactsCreate2Request struct via the builder pattern
...
> NameserversUpdateResponse DomainDomainNameserversCreate2(ctx, domain).NameserversUpdate(nameserversUpdate).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DomainAPI.DomainDomainNameserversCreate2(context.Background(), domain).NameserversUpdate(nameserversUpdate).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DomainAPI.DomainDomainNameserversCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DomainDomainNameserversCreate2`: NameserversUpdateResponse
	fmt.Fprintf(os.Stdout, "Response from `DomainAPI.DomainDomainNameserversCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDomainDomainNameserversCreate2Request struct via the builder pattern
