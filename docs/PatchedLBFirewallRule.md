...
`func (o *PatchedLBFirewallRule) GetCreated() time.Time`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *PatchedLBFirewallRule) GetCreatedOk() (*time.Time, bool)`
...
`func (o *PatchedLBFirewallRule) SetCreated(v time.Time)`
...
`func (o *PatchedLBFirewallRule) GetUpdated() time.Time`

GetUpdated returns the Updated field if non-nil, zero value otherwise.

### GetUpdatedOk

`func (o *PatchedLBFirewallRule) GetUpdatedOk() (*time.Time, bool)`
...
`func (o *PatchedLBFirewallRule) SetUpdated(v time.Time)`
