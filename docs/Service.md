...
`func NewService(id int32, billingCycle int32, hostname string, price float64, status ServiceStatusEnum, created string, modified string, terminated NullableString, nextInvoice string, primaryService NullableInt32, ) *Service`
