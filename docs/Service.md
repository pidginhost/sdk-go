...
`func NewService(id int32, billingCycle int32, hostname string, price float64, status Status63aEnum, created time.Time, modified time.Time, terminated NullableString, nextInvoice string, primaryService NullableInt32, ) *Service`
