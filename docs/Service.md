...
`func NewService(id int32, billingCycle int32, hostname string, price float64, status Status63aEnum, created string, modified string, terminated NullableString, nextInvoice string, primaryService NullableInt32, ) *Service`
...
`func (o *Service) GetStatus() Status63aEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *Service) GetStatusOk() (*Status63aEnum, bool)`
...
`func (o *Service) SetStatus(v Status63aEnum)`
...
`func (o *Service) GetModified() string`

GetModified returns the Modified field if non-nil, zero value otherwise.

### GetModifiedOk

`func (o *Service) GetModifiedOk() (*string, bool)`
...
`func (o *Service) SetModified(v string)`
