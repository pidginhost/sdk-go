...
func main() {
	id := "id_example" // string | 
	clusterDetail := *openapiclient.NewClusterDetail(int32(123), openapiclient.StatusA57Enum("pending"), "ClusterType_example", "KubeVersion_example", "PricePerMonth_example", "PricePerHour_example", false, "KubeconfigValidUntil_example", "Ipv4Address_example", "TalosVersion_example", "TalosUpgradeAvailable_example", "TalosNextVersion_example", "StorageQuotaGb_example", "LastPoolUsedBytes_example", "LastStorageSyncAt_example") // ClusterDetail | 
