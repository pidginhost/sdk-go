...
`func NewTCPRoute(id int32, name string, port int32, backendServiceName string, backendServicePort int32, statusReady NullableBool, statusMessage string, created string, updated string, ) *TCPRoute`
...
`func (o *TCPRoute) GetCreated() string`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *TCPRoute) GetCreatedOk() (*string, bool)`
...
`func (o *TCPRoute) SetCreated(v string)`
...
`func (o *TCPRoute) GetUpdated() string`

GetUpdated returns the Updated field if non-nil, zero value otherwise.

### GetUpdatedOk

`func (o *TCPRoute) GetUpdatedOk() (*string, bool)`
...
`func (o *TCPRoute) SetUpdated(v string)`
