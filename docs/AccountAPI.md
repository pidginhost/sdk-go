...
[**AccountApiTokensCreate2**](AccountAPI.md#AccountApiTokensCreate2) | **Post** /api/v1/account/api-tokens/ | 
[**AccountApiTokensDestroy**](AccountAPI.md#AccountApiTokensDestroy) | **Delete** /api/account/api-tokens/{id}/ | 
[**AccountApiTokensDestroy2**](AccountAPI.md#AccountApiTokensDestroy2) | **Delete** /api/v1/account/api-tokens/{id}/ | 
[**AccountApiTokensList**](AccountAPI.md#AccountApiTokensList) | **Get** /api/account/api-tokens/ | 
[**AccountApiTokensList2**](AccountAPI.md#AccountApiTokensList2) | **Get** /api/v1/account/api-tokens/ | 
[**AccountCompaniesCreate**](AccountAPI.md#AccountCompaniesCreate) | **Post** /api/account/companies/ | 
[**AccountCompaniesCreate2**](AccountAPI.md#AccountCompaniesCreate2) | **Post** /api/v1/account/companies/ | 
[**AccountCompaniesDestroy**](AccountAPI.md#AccountCompaniesDestroy) | **Delete** /api/account/companies/{id}/ | 
[**AccountCompaniesDestroy2**](AccountAPI.md#AccountCompaniesDestroy2) | **Delete** /api/v1/account/companies/{id}/ | 
...
[**AccountEmailsList2**](AccountAPI.md#AccountEmailsList2) | **Get** /api/v1/account/emails/ | 
...
func main() {
	aPITokenCreate := *openapiclient.NewAPITokenCreate(int32(123), "Name_example", "Key_example", time.Now()) // APITokenCreate | 
...
> APITokenCreate AccountApiTokensCreate2(ctx).APITokenCreate(aPITokenCreate).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccountAPI.AccountApiTokensCreate2(context.Background()).APITokenCreate(aPITokenCreate).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountApiTokensCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AccountApiTokensCreate2`: APITokenCreate
	fmt.Fprintf(os.Stdout, "Response from `AccountAPI.AccountApiTokensCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiAccountApiTokensCreate2Request struct via the builder pattern
...
> AccountApiTokensDestroy2(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AccountAPI.AccountApiTokensDestroy2(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountApiTokensDestroy2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiAccountApiTokensDestroy2Request struct via the builder pattern
...
> PaginatedAPITokenListList AccountApiTokensList2(ctx).Page(page).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccountAPI.AccountApiTokensList2(context.Background()).Page(page).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountApiTokensList2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AccountApiTokensList2`: PaginatedAPITokenListList
	fmt.Fprintf(os.Stdout, "Response from `AccountAPI.AccountApiTokensList2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiAccountApiTokensList2Request struct via the builder pattern
...
> Company AccountCompaniesCreate2(ctx).Company(company).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccountAPI.AccountCompaniesCreate2(context.Background()).Company(company).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountCompaniesCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AccountCompaniesCreate2`: Company
	fmt.Fprintf(os.Stdout, "Response from `AccountAPI.AccountCompaniesCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiAccountCompaniesCreate2Request struct via the builder pattern
...
> AccountCompaniesDestroy2(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AccountAPI.AccountCompaniesDestroy2(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountCompaniesDestroy2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiAccountCompaniesDestroy2Request struct via the builder pattern
...
> PaginatedEmailHistoryList AccountEmailsList2(ctx).Page(page).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccountAPI.AccountEmailsList2(context.Background()).Page(page).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AccountAPI.AccountEmailsList2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AccountEmailsList2`: PaginatedEmailHistoryList
	fmt.Fprintf(os.Stdout, "Response from `AccountAPI.AccountEmailsList2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiAccountEmailsList2Request struct via the builder pattern
