...
`func NewFirewallRule(id int32, direction FirewallRuleDirectionEnum, action FwPolicyOutEnum, hasError bool, errorMessage string, ) *FirewallRule`
...
`func (o *FirewallRule) GetDirection() FirewallRuleDirectionEnum`

GetDirection returns the Direction field if non-nil, zero value otherwise.

### GetDirectionOk

`func (o *FirewallRule) GetDirectionOk() (*FirewallRuleDirectionEnum, bool)`
...
`func (o *FirewallRule) SetDirection(v FirewallRuleDirectionEnum)`
