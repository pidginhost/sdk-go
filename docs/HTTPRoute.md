...
`func NewHTTPRoute(id int32, name string, hostnames []string, backendServiceName string, backendServicePort int32, statusReady NullableBool, statusMessage string, created string, updated string, ) *HTTPRoute`
...
`func (o *HTTPRoute) GetCreated() string`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *HTTPRoute) GetCreatedOk() (*string, bool)`
...
`func (o *HTTPRoute) SetCreated(v string)`
...
`func (o *HTTPRoute) GetUpdated() string`

GetUpdated returns the Updated field if non-nil, zero value otherwise.

### GetUpdatedOk

`func (o *HTTPRoute) GetUpdatedOk() (*string, bool)`
...
`func (o *HTTPRoute) SetUpdated(v string)`
