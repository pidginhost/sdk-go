...
`func NewNotificationSettingsResponse(message string, thresholdType string, thresholdAmount NullableString, thresholdDays NullableInt32, ) *NotificationSettingsResponse`
...
`func (o *NotificationSettingsResponse) GetThresholdAmount() string`

GetThresholdAmount returns the ThresholdAmount field if non-nil, zero value otherwise.

### GetThresholdAmountOk

`func (o *NotificationSettingsResponse) GetThresholdAmountOk() (*string, bool)`
...
`func (o *NotificationSettingsResponse) SetThresholdAmount(v string)`
