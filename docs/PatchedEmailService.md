...
**BounceRatePct** | Pointer to **string** |  | [optional] [readonly] 
**ComplaintRatePct** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *PatchedEmailService) GetStatus() ResourceStatusEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *PatchedEmailService) GetStatusOk() (*ResourceStatusEnum, bool)`
...
`func (o *PatchedEmailService) SetStatus(v ResourceStatusEnum)`
...
`func (o *PatchedEmailService) GetBounceRatePct() string`

GetBounceRatePct returns the BounceRatePct field if non-nil, zero value otherwise.

### GetBounceRatePctOk

`func (o *PatchedEmailService) GetBounceRatePctOk() (*string, bool)`
...
`func (o *PatchedEmailService) SetBounceRatePct(v string)`
...
`func (o *PatchedEmailService) GetComplaintRatePct() string`

GetComplaintRatePct returns the ComplaintRatePct field if non-nil, zero value otherwise.

### GetComplaintRatePctOk

`func (o *PatchedEmailService) GetComplaintRatePctOk() (*string, bool)`
...
`func (o *PatchedEmailService) SetComplaintRatePct(v string)`
