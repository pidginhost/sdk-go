...
`func (o *EmailService) GetBounceRatePct() string`

GetBounceRatePct returns the BounceRatePct field if non-nil, zero value otherwise.

### GetBounceRatePctOk

`func (o *EmailService) GetBounceRatePctOk() (*string, bool)`
...
`func (o *EmailService) SetBounceRatePct(v string)`
...
`func (o *EmailService) SetComplaintRatePct(v string)`
