...
`func NewEmailService(id int32, tier string, status ResourceStatusEnum, sandboxMode bool, autoSuspended bool, autoSuspendReason string, msgsSent24h int32, msgsSent30d int32, bounceRatePct float64, complaintRatePct float64, dedicatedIpAddon bool, quotaMonthly string, priceMonthlyEur string, ) *EmailService`
...
`func (o *EmailService) GetStatus() ResourceStatusEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *EmailService) GetStatusOk() (*ResourceStatusEnum, bool)`
...
`func (o *EmailService) SetStatus(v ResourceStatusEnum)`
