...
`func NewSubscription(id int32, status SubscriptionStatusEnum, service int32, serviceHostname string, subtotal string, vatValue string, total string, creationDate string, ) *Subscription`
...
`func (o *Subscription) GetSubtotal() string`

GetSubtotal returns the Subtotal field if non-nil, zero value otherwise.

### GetSubtotalOk

`func (o *Subscription) GetSubtotalOk() (*string, bool)`
...
`func (o *Subscription) SetSubtotal(v string)`
...
`func (o *Subscription) GetVatValue() string`

GetVatValue returns the VatValue field if non-nil, zero value otherwise.

### GetVatValueOk

`func (o *Subscription) GetVatValueOk() (*string, bool)`
...
`func (o *Subscription) SetVatValue(v string)`
...
`func (o *Subscription) GetTotal() string`

GetTotal returns the Total field if non-nil, zero value otherwise.

### GetTotalOk

`func (o *Subscription) GetTotalOk() (*string, bool)`
...
`func (o *Subscription) SetTotal(v string)`
