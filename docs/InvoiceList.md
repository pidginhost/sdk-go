...
`func NewInvoiceList(id int32, numberProforma string, numberFiscal string, status InvoiceStatusEnum, subtotal float64, vatValue float64, vatPercentage int32, total float64, invoiceDate string, dueDate NullableString, paymentDate NullableString, ) *InvoiceList`
