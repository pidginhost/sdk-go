...
`func (o *PatchedFirewallRule) GetDirection() FirewallRuleDirectionEnum`

GetDirection returns the Direction field if non-nil, zero value otherwise.

### GetDirectionOk

`func (o *PatchedFirewallRule) GetDirectionOk() (*FirewallRuleDirectionEnum, bool)`
...
`func (o *PatchedFirewallRule) SetDirection(v FirewallRuleDirectionEnum)`
