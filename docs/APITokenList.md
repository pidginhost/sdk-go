...
`func NewAPITokenList(id int32, name string, scope ScopeEnum, keyPrefix string, created time.Time, lastUsed NullableTime, requestCount int32, ) *APITokenList`
...
`func (o *APITokenList) GetCreated() time.Time`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *APITokenList) GetCreatedOk() (*time.Time, bool)`
...
`func (o *APITokenList) SetCreated(v time.Time)`
...
`func (o *APITokenList) GetLastUsed() time.Time`

GetLastUsed returns the LastUsed field if non-nil, zero value otherwise.

### GetLastUsedOk

`func (o *APITokenList) GetLastUsedOk() (*time.Time, bool)`
...
`func (o *APITokenList) SetLastUsed(v time.Time)`
