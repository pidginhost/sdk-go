...
`func NewTicketDetail(id int32, subject string, department Department, priority Priority3cdEnum, status StatusEf2Enum, created string, updated string, messages string, ) *TicketDetail`
