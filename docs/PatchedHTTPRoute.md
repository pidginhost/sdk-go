...
`func (o *PatchedHTTPRoute) GetCreated() string`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *PatchedHTTPRoute) GetCreatedOk() (*string, bool)`
...
`func (o *PatchedHTTPRoute) SetCreated(v string)`
...
`func (o *PatchedHTTPRoute) GetUpdated() string`

GetUpdated returns the Updated field if non-nil, zero value otherwise.

### GetUpdatedOk

`func (o *PatchedHTTPRoute) GetUpdatedOk() (*string, bool)`
...
`func (o *PatchedHTTPRoute) SetUpdated(v string)`
