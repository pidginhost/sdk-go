...
`func (o *PatchedTCPRoute) GetCreated() string`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *PatchedTCPRoute) GetCreatedOk() (*string, bool)`
...
`func (o *PatchedTCPRoute) SetCreated(v string)`
...
`func (o *PatchedTCPRoute) GetUpdated() string`

GetUpdated returns the Updated field if non-nil, zero value otherwise.

### GetUpdatedOk

`func (o *PatchedTCPRoute) GetUpdatedOk() (*string, bool)`
...
`func (o *PatchedTCPRoute) SetUpdated(v string)`
