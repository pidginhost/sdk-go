...
**Id** | **int32** |  | [readonly] 
**Tld** | **string** |  | 
**Price** | **string** | Euro without TVA | 
**RenewPrice** | Pointer to **NullableString** | Euro without TVA | [optional] 
**TransferPrice** | Pointer to **NullableString** | Euro without TVA | [optional] 
**Registrar** | **string** |  | 
...
`func NewTLD(id int32, tld string, price string, registrar string, ) *TLD`
...
`func (o *TLD) GetPrice() string`

GetPrice returns the Price field if non-nil, zero value otherwise.

### GetPriceOk

`func (o *TLD) GetPriceOk() (*string, bool)`
...
`func (o *TLD) SetRenewPrice(v string)`
...
`func (o *TLD) SetTransferPrice(v string)`
