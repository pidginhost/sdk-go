...
**Service** | [**NullableService**](Service.md) |  | [readonly] 
**IdnaName** | **string** |  | [readonly] 
**MaxRenewYears** | **int32** |  | [readonly] 
**ServiceStatus** | **NullableString** | Service status | [readonly] 
...
`func NewDomain(id int32, domain string, tld TLD, idna bool, expirationDate string, registrationDate NullableString, service NullableService, idnaName string, maxRenewYears int32, serviceStatus NullableString, contacts interface{}, ) *Domain`
...
`func (o *Domain) SetServiceNil(b bool)`

 SetServiceNil sets the value for Service to be an explicit nil

### UnsetService
`func (o *Domain) UnsetService()`
