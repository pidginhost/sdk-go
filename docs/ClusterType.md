...
`func NewClusterType(type_ ClusterTypeEnum, workerNodePackages []ClusterPackage, ) *ClusterType`
...
`func (o *ClusterType) GetType() ClusterTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ClusterType) GetTypeOk() (*ClusterTypeEnum, bool)`
...
`func (o *ClusterType) SetType(v ClusterTypeEnum)`
