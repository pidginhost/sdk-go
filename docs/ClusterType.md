...
`func NewClusterType(type_ Type2faEnum, workerNodePackages []ClusterPackage, ) *ClusterType`
...
`func (o *ClusterType) GetType() Type2faEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ClusterType) GetTypeOk() (*Type2faEnum, bool)`
...
`func (o *ClusterType) SetType(v Type2faEnum)`
