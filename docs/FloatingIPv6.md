...
`func NewFloatingIPv6(id int32, address string, gateway string, prefix int32, reverseDns string, authorizedVmCount int32, createdAt string, ) *FloatingIPv6`
...
`func (o *FloatingIPv6) GetReverseDns() string`

GetReverseDns returns the ReverseDns field if non-nil, zero value otherwise.

### GetReverseDnsOk

`func (o *FloatingIPv6) GetReverseDnsOk() (*string, bool)`
...
`func (o *FloatingIPv6) SetReverseDns(v string)`
