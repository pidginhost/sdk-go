...
`func NewServerDetail(id int32, hostname string, image string, package_ string, cpus int32, memory int32, diskSize int32, machine map[string]interface{}, volumes []Volume, networks map[string]interface{}, status StatusA57Enum, username string, destroyProtection bool, haEnabled bool, ) *ServerDetail`
