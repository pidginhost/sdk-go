...
**Results** | [**[]Company**](Company.md) |  | 

## Methods

### NewPaginatedCompanyList

`func NewPaginatedCompanyList(count int32, results []Company, ) *PaginatedCompanyList`
...
`func (o *PaginatedCompanyList) GetCount() int32`

GetCount returns the Count field if non-nil, zero value otherwise.

### GetCountOk

`func (o *PaginatedCompanyList) GetCountOk() (*int32, bool)`
...
`func (o *PaginatedCompanyList) SetCount(v int32)`
