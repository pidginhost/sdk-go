...
`func NewServer(id int32, image string, package_ string, cpus int32, memory int32, diskSize int32, destroyProtection bool, haEnabled bool, networks map[string]interface{}, ) *Server`
