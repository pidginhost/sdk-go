...
`func (o *LowBalanceSettings) GetThresholdAmount() string`

GetThresholdAmount returns the ThresholdAmount field if non-nil, zero value otherwise.

### GetThresholdAmountOk

`func (o *LowBalanceSettings) GetThresholdAmountOk() (*string, bool)`
...
`func (o *LowBalanceSettings) SetThresholdAmount(v string)`
