...
`func NewDedicatedServer(id int32, hostname string, status Status63aEnum, price float64, nextInvoice string, created string, billingCycle string, serverStatus string, ips string, osName string, ) *DedicatedServer`
