...
`func NewDedicatedServer(id int32, hostname string, status ServiceStatusEnum, price float64, nextInvoice string, created string, billingCycle string, serverStatus string, ips string, osName string, ) *DedicatedServer`
