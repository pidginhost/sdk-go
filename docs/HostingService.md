...
`func NewHostingService(id int32, hostname string, status ServiceStatusEnum, price float64, nextInvoice string, created string, billingCycle string, packageName string, nodeUrl string, username string, ) *HostingService`
...
`func (o *HostingService) GetStatus() ServiceStatusEnum`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *HostingService) GetStatusOk() (*ServiceStatusEnum, bool)`
...
`func (o *HostingService) SetStatus(v ServiceStatusEnum)`
...
`func (o *HostingService) GetCreated() string`

GetCreated returns the Created field if non-nil, zero value otherwise.

### GetCreatedOk

`func (o *HostingService) GetCreatedOk() (*string, bool)`
...
`func (o *HostingService) SetCreated(v string)`
