...
`func NewHostingService(id int32, hostname string, status Status63aEnum, price float64, nextInvoice string, created string, billingCycle string, packageName string, nodeUrl string, username string, ) *HostingService`
