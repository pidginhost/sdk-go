...
`func NewProfile(firstName string, lastName string, funds string, phone string, ) *Profile`
...
`func (o *Profile) GetFunds() string`

GetFunds returns the Funds field if non-nil, zero value otherwise.

### GetFundsOk

`func (o *Profile) GetFundsOk() (*string, bool)`
...
`func (o *Profile) SetFunds(v string)`
