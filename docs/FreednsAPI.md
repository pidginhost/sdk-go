...
[**FreednsDnsActivateCreate2**](FreednsAPI.md#FreednsDnsActivateCreate2) | **Post** /api/v1/freedns/dns/activate/ | 
[**FreednsDnsAddRecordCreate**](FreednsAPI.md#FreednsDnsAddRecordCreate) | **Post** /api/freedns/dns/add-record/ | 
[**FreednsDnsAddRecordCreate2**](FreednsAPI.md#FreednsDnsAddRecordCreate2) | **Post** /api/v1/freedns/dns/add-record/ | 
[**FreednsDnsDeactivateCreate**](FreednsAPI.md#FreednsDnsDeactivateCreate) | **Post** /api/freedns/dns/deactivate/ | 
[**FreednsDnsDeactivateCreate2**](FreednsAPI.md#FreednsDnsDeactivateCreate2) | **Post** /api/v1/freedns/dns/deactivate/ | 
[**FreednsDnsDeleteRecordCreate**](FreednsAPI.md#FreednsDnsDeleteRecordCreate) | **Post** /api/freedns/dns/delete-record/ | 
[**FreednsDnsDeleteRecordCreate2**](FreednsAPI.md#FreednsDnsDeleteRecordCreate2) | **Post** /api/v1/freedns/dns/delete-record/ | 
[**FreednsDnsList**](FreednsAPI.md#FreednsDnsList) | **Get** /api/freedns/dns/ | 
[**FreednsDnsList2**](FreednsAPI.md#FreednsDnsList2) | **Get** /api/v1/freedns/dns/ | 
[**FreednsDnsRecordsList**](FreednsAPI.md#FreednsDnsRecordsList) | **Get** /api/freedns/dns/records/ | 
[**FreednsDnsRecordsList2**](FreednsAPI.md#FreednsDnsRecordsList2) | **Get** /api/v1/freedns/dns/records/ | 
...
> ActivateFreeDNSResponse FreednsDnsActivateCreate2(ctx).ActivateFreeDNS(activateFreeDNS).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsActivateCreate2(context.Background()).ActivateFreeDNS(activateFreeDNS).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsActivateCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsActivateCreate2`: ActivateFreeDNSResponse
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsActivateCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsActivateCreate2Request struct via the builder pattern
...
> DNSRecordMutateResponse FreednsDnsAddRecordCreate2(ctx).Domain(domain).Source(source).DNSRecordCreate(dNSRecordCreate).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsAddRecordCreate2(context.Background()).Domain(domain).Source(source).DNSRecordCreate(dNSRecordCreate).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsAddRecordCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsAddRecordCreate2`: DNSRecordMutateResponse
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsAddRecordCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsAddRecordCreate2Request struct via the builder pattern
...
> DeactivateFreeDNSResponse FreednsDnsDeactivateCreate2(ctx).DeactivateFreeDNS(deactivateFreeDNS).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsDeactivateCreate2(context.Background()).DeactivateFreeDNS(deactivateFreeDNS).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsDeactivateCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsDeactivateCreate2`: DeactivateFreeDNSResponse
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsDeactivateCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsDeactivateCreate2Request struct via the builder pattern
...
> DeleteRecordResponse FreednsDnsDeleteRecordCreate2(ctx).Domain(domain).Source(source).DeleteRecord(deleteRecord).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsDeleteRecordCreate2(context.Background()).Domain(domain).Source(source).DeleteRecord(deleteRecord).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsDeleteRecordCreate2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsDeleteRecordCreate2`: DeleteRecordResponse
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsDeleteRecordCreate2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsDeleteRecordCreate2Request struct via the builder pattern
...
> []FreeDNSDomain FreednsDnsList2(ctx).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsList2(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsList2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsList2`: []FreeDNSDomain
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsList2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsList2Request struct via the builder pattern
...
> []DNSRecord FreednsDnsRecordsList2(ctx).Domain(domain).Source(source).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FreednsAPI.FreednsDnsRecordsList2(context.Background()).Domain(domain).Source(source).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FreednsAPI.FreednsDnsRecordsList2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FreednsDnsRecordsList2`: []DNSRecord
	fmt.Fprintf(os.Stdout, "Response from `FreednsAPI.FreednsDnsRecordsList2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFreednsDnsRecordsList2Request struct via the builder pattern
