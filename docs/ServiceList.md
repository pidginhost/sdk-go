...
`func NewServiceList(id int32, hostname string, status ServiceStatusEnum, price float64, nextInvoice string, created string, billingCycle string, autoPayment bool, company NullableServiceCompany, ) *ServiceList`
