...
`func NewServiceList(id int32, hostname string, status Status63aEnum, price float64, nextInvoice string, created string, billingCycle string, autoPayment string, company string, ) *ServiceList`
