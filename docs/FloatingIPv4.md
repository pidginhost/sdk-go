...
`func NewFloatingIPv4(id int32, address string, gateway string, prefix int32, reverseDns string, authorizedVmCount int32, createdAt string, ) *FloatingIPv4`
...
`func (o *FloatingIPv4) GetReverseDns() string`

GetReverseDns returns the ReverseDns field if non-nil, zero value otherwise.

### GetReverseDnsOk

`func (o *FloatingIPv4) GetReverseDnsOk() (*string, bool)`
...
`func (o *FloatingIPv4) SetReverseDns(v string)`
