...
type PatchedFirewallRule struct {
	...
	Direction *FirewallRuleDirectionEnum `json:"direction,omitempty"`
...
func (o *PatchedFirewallRule) GetDirection() FirewallRuleDirectionEnum {
	if o == nil || IsNil(o.Direction) {
		var ret FirewallRuleDirectionEnum
		return ret
	}
	return *o.Direction
}
...
// SetDirection gets a reference to the given FirewallRuleDirectionEnum and assigns it to the Direction field.
