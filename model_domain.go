...
type Domain struct {
	...
	Service NullableService `json:"service"`
	IdnaName string `json:"idna_name"`
	MaxRenewYears int32 `json:"max_renew_years"`
	// Service status
	ServiceStatus NullableString `json:"service_status"`
...
// If the value is explicit nil, the zero value for Service will be returned
