...
type ApiCloudIpv4RdnsCreate2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
	reverseDNS *ReverseDNS
...
func (r ApiCloudIpv4RdnsCreate2Request) ReverseDNS(reverseDNS ReverseDNS) ApiCloudIpv4RdnsCreate2Request {
	r.reverseDNS = &reverseDNS
	return r
}

func (r ApiCloudIpv4RdnsCreate2Request) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudIpv4RdnsCreate2Execute(r)
}

/*
CloudIpv4RdnsCreate2 Method for CloudIpv4RdnsCreate2

Get or update reverse DNS (PTR) for this IPv4 address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this Public IPv4.
 @return ApiCloudIpv4RdnsCreate2Request
*/
func (a *CloudAPIService) CloudIpv4RdnsCreate2(ctx context.Context, id int32) ApiCloudIpv4RdnsCreate2Request {
	return ApiCloudIpv4RdnsCreate2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudIpv4RdnsCreate2Execute(r ApiCloudIpv4RdnsCreate2Request) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudIpv4RdnsCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cloud/ipv4/{id}/rdns/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCloudIpv4RdnsRetrieve2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudIpv4RdnsRetrieve2Request) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudIpv4RdnsRetrieve2Execute(r)
}

/*
CloudIpv4RdnsRetrieve2 Method for CloudIpv4RdnsRetrieve2

Get or update reverse DNS (PTR) for this IPv4 address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this Public IPv4.
 @return ApiCloudIpv4RdnsRetrieve2Request
*/
func (a *CloudAPIService) CloudIpv4RdnsRetrieve2(ctx context.Context, id int32) ApiCloudIpv4RdnsRetrieve2Request {
	return ApiCloudIpv4RdnsRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudIpv4RdnsRetrieve2Execute(r ApiCloudIpv4RdnsRetrieve2Request) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudIpv4RdnsRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCloudIpv6RdnsCreate2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
	reverseDNS *ReverseDNS
...
func (r ApiCloudIpv6RdnsCreate2Request) ReverseDNS(reverseDNS ReverseDNS) ApiCloudIpv6RdnsCreate2Request {
	r.reverseDNS = &reverseDNS
	return r
}

func (r ApiCloudIpv6RdnsCreate2Request) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudIpv6RdnsCreate2Execute(r)
}

/*
CloudIpv6RdnsCreate2 Method for CloudIpv6RdnsCreate2

Get or update reverse DNS (PTR) for this IPv6 address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this Public IPv6.
 @return ApiCloudIpv6RdnsCreate2Request
*/
func (a *CloudAPIService) CloudIpv6RdnsCreate2(ctx context.Context, id int32) ApiCloudIpv6RdnsCreate2Request {
	return ApiCloudIpv6RdnsCreate2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudIpv6RdnsCreate2Execute(r ApiCloudIpv6RdnsCreate2Request) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudIpv6RdnsCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cloud/ipv6/{id}/rdns/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCloudIpv6RdnsRetrieve2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudIpv6RdnsRetrieve2Request) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudIpv6RdnsRetrieve2Execute(r)
}

/*
CloudIpv6RdnsRetrieve2 Method for CloudIpv6RdnsRetrieve2

Get or update reverse DNS (PTR) for this IPv6 address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this Public IPv6.
 @return ApiCloudIpv6RdnsRetrieve2Request
*/
func (a *CloudAPIService) CloudIpv6RdnsRetrieve2(ctx context.Context, id int32) ApiCloudIpv6RdnsRetrieve2Request {
	return ApiCloudIpv6RdnsRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudIpv6RdnsRetrieve2Execute(r ApiCloudIpv6RdnsRetrieve2Request) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudIpv6RdnsRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCloudServersActivityRetrieve2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudServersActivityRetrieve2Request) Execute() (*ActivityLogResponse, *http.Response, error) {
	return r.ApiService.CloudServersActivityRetrieve2Execute(r)
}

/*
CloudServersActivityRetrieve2 Method for CloudServersActivityRetrieve2

Get activity log for a server.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this virtual machine.
 @return ApiCloudServersActivityRetrieve2Request
*/
func (a *CloudAPIService) CloudServersActivityRetrieve2(ctx context.Context, id int32) ApiCloudServersActivityRetrieve2Request {
	return ApiCloudServersActivityRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ActivityLogResponse
func (a *CloudAPIService) CloudServersActivityRetrieve2Execute(r ApiCloudServersActivityRetrieve2Request) (*ActivityLogResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudServersActivityRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cloud/servers/{id}/activity/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiCloudServersPartialUpdate2Request) PatchedServerDetail(patchedServerDetail PatchedServerDetail) ApiCloudServersPartialUpdate2Request {
	r.patchedServerDetail = &patchedServerDetail
	return r
}

func (r ApiCloudServersPartialUpdate2Request) Execute() (*ServerDetail, *http.Response, error) {
...
// Execute executes the request
//  @return ServerDetail
func (a *CloudAPIService) CloudServersPartialUpdate2Execute(r ApiCloudServersPartialUpdate2Request) (*ServerDetail, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiCloudServersRetrieve2Request) Execute() (*ServerDetail, *http.Response, error) {
...
// Execute executes the request
//  @return ServerDetail
func (a *CloudAPIService) CloudServersRetrieve2Execute(r ApiCloudServersRetrieve2Request) (*ServerDetail, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiCloudServersUpdate2Request) ServerDetail(serverDetail ServerDetail) ApiCloudServersUpdate2Request {
	r.serverDetail = &serverDetail
	return r
}

func (r ApiCloudServersUpdate2Request) Execute() (*ServerDetail, *http.Response, error) {
...
// Execute executes the request
//  @return ServerDetail
func (a *CloudAPIService) CloudServersUpdate2Execute(r ApiCloudServersUpdate2Request) (*ServerDetail, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiCloudServersUsageRetrieve2Request struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudServersUsageRetrieve2Request) Execute() (*ServerUsageResponse, *http.Response, error) {
	return r.ApiService.CloudServersUsageRetrieve2Execute(r)
}

/*
CloudServersUsageRetrieve2 Method for CloudServersUsageRetrieve2

Get current resource usage for a server.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this virtual machine.
 @return ApiCloudServersUsageRetrieve2Request
*/
func (a *CloudAPIService) CloudServersUsageRetrieve2(ctx context.Context, id int32) ApiCloudServersUsageRetrieve2Request {
	return ApiCloudServersUsageRetrieve2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ServerUsageResponse
func (a *CloudAPIService) CloudServersUsageRetrieve2Execute(r ApiCloudServersUsageRetrieve2Request) (*ServerUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudServersUsageRetrieve2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cloud/servers/{id}/usage/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
