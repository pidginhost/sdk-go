...
type ApiCloudFloatingIpv4RdnsCreateRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
...
func (r ApiCloudFloatingIpv4RdnsCreateRequest) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv4RdnsCreateExecute(r)
}

/*
CloudFloatingIpv4RdnsCreate Method for CloudFloatingIpv4RdnsCreate

Get or update reverse DNS (PTR) for the IPv4 address wrapped by this floating IP.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this floating IPv4.
 @return ApiCloudFloatingIpv4RdnsCreateRequest
*/
func (a *CloudAPIService) CloudFloatingIpv4RdnsCreate(ctx context.Context, id int32) ApiCloudFloatingIpv4RdnsCreateRequest {
	return ApiCloudFloatingIpv4RdnsCreateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudFloatingIpv4RdnsCreateExecute(r ApiCloudFloatingIpv4RdnsCreateRequest) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv4RdnsCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/cloud/floating-ipv4/{id}/rdns/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCloudFloatingIpv4RdnsRetrieveRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudFloatingIpv4RdnsRetrieveRequest) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv4RdnsRetrieveExecute(r)
}

/*
CloudFloatingIpv4RdnsRetrieve Method for CloudFloatingIpv4RdnsRetrieve

Get or update reverse DNS (PTR) for the IPv4 address wrapped by this floating IP.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this floating IPv4.
 @return ApiCloudFloatingIpv4RdnsRetrieveRequest
*/
func (a *CloudAPIService) CloudFloatingIpv4RdnsRetrieve(ctx context.Context, id int32) ApiCloudFloatingIpv4RdnsRetrieveRequest {
	return ApiCloudFloatingIpv4RdnsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudFloatingIpv4RdnsRetrieveExecute(r ApiCloudFloatingIpv4RdnsRetrieveRequest) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv4RdnsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCloudFloatingIpv6RdnsCreateRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
	reverseDNS *ReverseDNS
...
func (r ApiCloudFloatingIpv6RdnsCreateRequest) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv6RdnsCreateExecute(r)
}

/*
CloudFloatingIpv6RdnsCreate Method for CloudFloatingIpv6RdnsCreate

Get or update reverse DNS (PTR) for the IPv6 address wrapped by this floating IP.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this floating IPv6.
 @return ApiCloudFloatingIpv6RdnsCreateRequest
*/
func (a *CloudAPIService) CloudFloatingIpv6RdnsCreate(ctx context.Context, id int32) ApiCloudFloatingIpv6RdnsCreateRequest {
	return ApiCloudFloatingIpv6RdnsCreateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudFloatingIpv6RdnsCreateExecute(r ApiCloudFloatingIpv6RdnsCreateRequest) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv6RdnsCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/cloud/floating-ipv6/{id}/rdns/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCloudFloatingIpv6RdnsRetrieveRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudFloatingIpv6RdnsRetrieveRequest) Execute() (*ReverseDNS, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv6RdnsRetrieveExecute(r)
}

/*
CloudFloatingIpv6RdnsRetrieve Method for CloudFloatingIpv6RdnsRetrieve

Get or update reverse DNS (PTR) for the IPv6 address wrapped by this floating IP.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this floating IPv6.
 @return ApiCloudFloatingIpv6RdnsRetrieveRequest
*/
func (a *CloudAPIService) CloudFloatingIpv6RdnsRetrieve(ctx context.Context, id int32) ApiCloudFloatingIpv6RdnsRetrieveRequest {
	return ApiCloudFloatingIpv6RdnsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ReverseDNS
func (a *CloudAPIService) CloudFloatingIpv6RdnsRetrieveExecute(r ApiCloudFloatingIpv6RdnsRetrieveRequest) (*ReverseDNS, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv6RdnsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Filter packages available on the given hardware generation (slug). Excludes free-tier-only packages when the generation is not free-tier eligible.
func (r ApiCloudServerPackagesListRequest) Generation(generation string) ApiCloudServerPackagesListRequest {
...
func (a *CloudAPIService) CloudServerPackagesListExecute(r ApiCloudServerPackagesListRequest) (*PaginatedServerProductList, *http.Response, error) {
	...
	if r.generation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "generation", r.generation, "form", "")
	}
	if r.page != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page", r.page, "form", "")
	}
...
func (r ApiCloudServersAttachIpv4CreateRequest) AttachIPv4Request(attachIPv4Request AttachIPv4Request) ApiCloudServersAttachIpv4CreateRequest {
	r.attachIPv4Request = &attachIPv4Request
	return r
}

func (r ApiCloudServersAttachIpv4CreateRequest) Execute() (*AttachIPv4Response, *http.Response, error) {
...
func (a *CloudAPIService) CloudServersAttachIpv4CreateExecute(r ApiCloudServersAttachIpv4CreateRequest) (*AttachIPv4Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AttachIPv4Response
	)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.attachIPv4Request == nil {
		return localVarReturnValue, nil, reportError("attachIPv4Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.attachIPv4Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
func (r ApiCloudServersAttachIpv6CreateRequest) AttachIPv6Request(attachIPv6Request AttachIPv6Request) ApiCloudServersAttachIpv6CreateRequest {
	r.attachIPv6Request = &attachIPv6Request
	return r
}

func (r ApiCloudServersAttachIpv6CreateRequest) Execute() (*AttachIPv6Response, *http.Response, error) {
...
func (a *CloudAPIService) CloudServersAttachIpv6CreateExecute(r ApiCloudServersAttachIpv6CreateRequest) (*AttachIPv6Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AttachIPv6Response
	)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.attachIPv6Request == nil {
		return localVarReturnValue, nil, reportError("attachIPv6Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.attachIPv6Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
type ApiCloudServersBootIsosListRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
	page *int32
...
/*
CloudServersBootIsosList Method for CloudServersBootIsosList

List the ISO catalog entries visible to this user and their package compatibility.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this virtual machine.
 @return ApiCloudServersBootIsosListRequest
*/
func (a *CloudAPIService) CloudServersBootIsosList(ctx context.Context, id int32) ApiCloudServersBootIsosListRequest {
	return ApiCloudServersBootIsosListRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *CloudAPIService) CloudServersBootIsosListExecute(r ApiCloudServersBootIsosListRequest) (*PaginatedBootISOList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/cloud/servers/{id}/boot-isos/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiCloudServersDestroyProtectionCreateRequest) Execute() (*DestroyProtectionResponse, *http.Response, error) {
...
func (a *CloudAPIService) CloudServersDestroyProtectionCreateExecute(r ApiCloudServersDestroyProtectionCreateRequest) (*DestroyProtectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DestroyProtectionResponse
	)
...
// ID or slug of the IPv4 address to detach.
func (r ApiCloudServersDetachIpv4CreateRequest) Ipv4(ipv4 string) ApiCloudServersDetachIpv4CreateRequest {
	r.ipv4 = &ipv4
	return r
}

func (r ApiCloudServersDetachIpv4CreateRequest) Execute() (*ServerDetachIPv4Response, *http.Response, error) {
...
func (a *CloudAPIService) CloudServersDetachIpv4CreateExecute(r ApiCloudServersDetachIpv4CreateRequest) (*ServerDetachIPv4Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ServerDetachIPv4Response
	)
...
type ApiCloudServersRescueEnterCreateRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
...
func (r ApiCloudServersRescueEnterCreateRequest) IsoBootRequest(isoBootRequest IsoBootRequest) ApiCloudServersRescueEnterCreateRequest {
	r.isoBootRequest = &isoBootRequest
	return r
}

func (r ApiCloudServersRescueEnterCreateRequest) Execute() (*RescueEnterQueued, *http.Response, error) {
	return r.ApiService.CloudServersRescueEnterCreateExecute(r)
}

/*
CloudServersRescueEnterCreate Method for CloudServersRescueEnterCreate
...
Boot the server from the default rescue image or a catalog ISO. The server is powered off first; use the console to complete the repair or installation. Not available for HA servers.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this virtual machine.
 @return ApiCloudServersRescueEnterCreateRequest
*/
func (a *CloudAPIService) CloudServersRescueEnterCreate(ctx context.Context, id int32) ApiCloudServersRescueEnterCreateRequest {
	return ApiCloudServersRescueEnterCreateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *CloudAPIService) CloudServersRescueEnterCreateExecute(r ApiCloudServersRescueEnterCreateRequest) (*RescueEnterQueued, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RescueEnterQueued
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudServersRescueEnterCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/cloud/servers/{id}/rescue/enter/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	// body params
	localVarPostBody = r.isoBootRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
type ApiCloudServersRescueExitCreateRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudServersRescueExitCreateRequest) Execute() (*RescueExitQueued, *http.Response, error) {
	return r.ApiService.CloudServersRescueExitCreateExecute(r)
}

/*
CloudServersRescueExitCreate Method for CloudServersRescueExitCreate

Exit rescue mode: detach the rescue ISO, restore the original boot order, and boot normally.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this virtual machine.
 @return ApiCloudServersRescueExitCreateRequest
*/
func (a *CloudAPIService) CloudServersRescueExitCreate(ctx context.Context, id int32) ApiCloudServersRescueExitCreateRequest {
	return ApiCloudServersRescueExitCreateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *CloudAPIService) CloudServersRescueExitCreateExecute(r ApiCloudServersRescueExitCreateRequest) (*RescueExitQueued, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RescueExitQueued
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudServersRescueExitCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/cloud/servers/{id}/rescue/exit/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
