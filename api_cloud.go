...
type ApiCloudFloatingIpv4AuthorizationsRetrieveRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudFloatingIpv4AuthorizationsRetrieveRequest) Execute() (*FloatingIPv4, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv4AuthorizationsRetrieveExecute(r)
}

/*
CloudFloatingIpv4AuthorizationsRetrieve Method for CloudFloatingIpv4AuthorizationsRetrieve
...
keepalived/VRRP.
 ...
 @return ApiCloudFloatingIpv4AuthorizationsRetrieveRequest
*/
func (a *CloudAPIService) CloudFloatingIpv4AuthorizationsRetrieve(ctx context.Context, id int32) ApiCloudFloatingIpv4AuthorizationsRetrieveRequest {
	return ApiCloudFloatingIpv4AuthorizationsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return FloatingIPv4
func (a *CloudAPIService) CloudFloatingIpv4AuthorizationsRetrieveExecute(r ApiCloudFloatingIpv4AuthorizationsRetrieveRequest) (*FloatingIPv4, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv4AuthorizationsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCloudFloatingIpv6AuthorizationsRetrieveRequest struct {
	ctx context.Context
	ApiService *CloudAPIService
	id int32
}

func (r ApiCloudFloatingIpv6AuthorizationsRetrieveRequest) Execute() (*FloatingIPv6, *http.Response, error) {
	return r.ApiService.CloudFloatingIpv6AuthorizationsRetrieveExecute(r)
}

/*
CloudFloatingIpv6AuthorizationsRetrieve Method for CloudFloatingIpv6AuthorizationsRetrieve

Manage floating IPv6 addresses.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id A unique integer value identifying this floating IPv6.
 @return ApiCloudFloatingIpv6AuthorizationsRetrieveRequest
*/
func (a *CloudAPIService) CloudFloatingIpv6AuthorizationsRetrieve(ctx context.Context, id int32) ApiCloudFloatingIpv6AuthorizationsRetrieveRequest {
	return ApiCloudFloatingIpv6AuthorizationsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return FloatingIPv6
func (a *CloudAPIService) CloudFloatingIpv6AuthorizationsRetrieveExecute(r ApiCloudFloatingIpv6AuthorizationsRetrieveRequest) (*FloatingIPv6, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudAPIService.CloudFloatingIpv6AuthorizationsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
