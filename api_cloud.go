...
func (r ApiCloudServersDetachIpv4CreateRequest) Execute() (*DetachIPv4Response, *http.Response, error) {
...
// Execute executes the request
//  @return DetachIPv4Response
func (a *CloudAPIService) CloudServersDetachIpv4CreateExecute(r ApiCloudServersDetachIpv4CreateRequest) (*DetachIPv4Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
