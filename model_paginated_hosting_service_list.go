...
// checks if the PaginatedHostingServiceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedHostingServiceList{}

// PaginatedHostingServiceList struct for PaginatedHostingServiceList
type PaginatedHostingServiceList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []HostingService `json:"results"`
}

type _PaginatedHostingServiceList PaginatedHostingServiceList
...
func NewPaginatedHostingServiceList(count int32, results []HostingService) *PaginatedHostingServiceList {
	this := PaginatedHostingServiceList{}
	this.Count = count
...
func (o *PaginatedHostingServiceList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedHostingServiceList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedHostingServiceList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedHostingServiceList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedHostingServiceList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedHostingServiceList := _PaginatedHostingServiceList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedHostingServiceList)

	if err != nil {
		return err
	}

	*o = PaginatedHostingServiceList(varPaginatedHostingServiceList)

	return err
}

type NullablePaginatedHostingServiceList struct {
	value *PaginatedHostingServiceList
	isSet bool
}

func (v NullablePaginatedHostingServiceList) Get() *PaginatedHostingServiceList {
	return v.value
}

func (v *NullablePaginatedHostingServiceList) Set(val *PaginatedHostingServiceList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedHostingServiceList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedHostingServiceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedHostingServiceList(val *PaginatedHostingServiceList) *NullablePaginatedHostingServiceList {
	return &NullablePaginatedHostingServiceList{value: val, isSet: true}
}

func (v NullablePaginatedHostingServiceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedHostingServiceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
