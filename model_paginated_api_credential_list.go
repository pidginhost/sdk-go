...
// checks if the PaginatedApiCredentialList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApiCredentialList{}

// PaginatedApiCredentialList struct for PaginatedApiCredentialList
type PaginatedApiCredentialList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ApiCredential `json:"results"`
}

type _PaginatedApiCredentialList PaginatedApiCredentialList
...
func NewPaginatedApiCredentialList(count int32, results []ApiCredential) *PaginatedApiCredentialList {
	this := PaginatedApiCredentialList{}
	this.Count = count
...
func (o *PaginatedApiCredentialList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedApiCredentialList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedApiCredentialList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedApiCredentialList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedApiCredentialList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedApiCredentialList := _PaginatedApiCredentialList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedApiCredentialList)

	if err != nil {
		return err
	}

	*o = PaginatedApiCredentialList(varPaginatedApiCredentialList)

	return err
}

type NullablePaginatedApiCredentialList struct {
	value *PaginatedApiCredentialList
	isSet bool
}

func (v NullablePaginatedApiCredentialList) Get() *PaginatedApiCredentialList {
	return v.value
}

func (v *NullablePaginatedApiCredentialList) Set(val *PaginatedApiCredentialList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedApiCredentialList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedApiCredentialList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedApiCredentialList(val *PaginatedApiCredentialList) *NullablePaginatedApiCredentialList {
	return &NullablePaginatedApiCredentialList{value: val, isSet: true}
}

func (v NullablePaginatedApiCredentialList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedApiCredentialList) UnmarshalJSON(src []byte) error {
	v.isSet = true
