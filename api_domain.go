...
type ApiDomainDomainCancelCreate2Request struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
}

func (r ApiDomainDomainCancelCreate2Request) Execute() (*DomainCancelResponse, *http.Response, error) {
	return r.ApiService.DomainDomainCancelCreate2Execute(r)
}

/*
DomainDomainCancelCreate2 Method for DomainDomainCancelCreate2

Cancel the service associated with this domain.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain
 @return ApiDomainDomainCancelCreate2Request
*/
func (a *DomainAPIService) DomainDomainCancelCreate2(ctx context.Context, domain string) ApiDomainDomainCancelCreate2Request {
	return ApiDomainDomainCancelCreate2Request{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
// Execute executes the request
//  @return DomainCancelResponse
func (a *DomainAPIService) DomainDomainCancelCreate2Execute(r ApiDomainDomainCancelCreate2Request) (*DomainCancelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainCancelCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/domain/domain/{domain}/cancel/"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterValueToString(r.domain, "domain")), -1)
...
type ApiDomainDomainContactsCreate2Request struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
	contactsUpdate *ContactsUpdate
...
func (r ApiDomainDomainContactsCreate2Request) ContactsUpdate(contactsUpdate ContactsUpdate) ApiDomainDomainContactsCreate2Request {
	r.contactsUpdate = &contactsUpdate
	return r
}

func (r ApiDomainDomainContactsCreate2Request) Execute() (*ContactsUpdateResponse, *http.Response, error) {
	return r.ApiService.DomainDomainContactsCreate2Execute(r)
}

/*
DomainDomainContactsCreate2 Method for DomainDomainContactsCreate2

Update a contact on this domain using a saved DomainRegistrant.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain
 @return ApiDomainDomainContactsCreate2Request
*/
func (a *DomainAPIService) DomainDomainContactsCreate2(ctx context.Context, domain string) ApiDomainDomainContactsCreate2Request {
	return ApiDomainDomainContactsCreate2Request{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
// Execute executes the request
//  @return ContactsUpdateResponse
func (a *DomainAPIService) DomainDomainContactsCreate2Execute(r ApiDomainDomainContactsCreate2Request) (*ContactsUpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainContactsCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/domain/domain/{domain}/contacts/"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterValueToString(r.domain, "domain")), -1)
...
type ApiDomainDomainNameserversCreate2Request struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
	nameserversUpdate *NameserversUpdate
...
func (r ApiDomainDomainNameserversCreate2Request) NameserversUpdate(nameserversUpdate NameserversUpdate) ApiDomainDomainNameserversCreate2Request {
	r.nameserversUpdate = &nameserversUpdate
	return r
}

func (r ApiDomainDomainNameserversCreate2Request) Execute() (*NameserversUpdateResponse, *http.Response, error) {
	return r.ApiService.DomainDomainNameserversCreate2Execute(r)
}

/*
DomainDomainNameserversCreate2 Method for DomainDomainNameserversCreate2

Update nameservers for this domain.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain
 @return ApiDomainDomainNameserversCreate2Request
*/
func (a *DomainAPIService) DomainDomainNameserversCreate2(ctx context.Context, domain string) ApiDomainDomainNameserversCreate2Request {
	return ApiDomainDomainNameserversCreate2Request{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
// Execute executes the request
//  @return NameserversUpdateResponse
func (a *DomainAPIService) DomainDomainNameserversCreate2Execute(r ApiDomainDomainNameserversCreate2Request) (*NameserversUpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainNameserversCreate2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/domain/domain/{domain}/nameservers/"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterValueToString(r.domain, "domain")), -1)
