...
type ApiDomainDomainDnsCreateRequest struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
	dNSGlue *DNSGlue
...
func (r ApiDomainDomainDnsCreateRequest) Execute() (*DNSGlue, *http.Response, error) {
	return r.ApiService.DomainDomainDnsCreateExecute(r)
}

/*
DomainDomainDnsCreate Method for DomainDomainDnsCreate
...
for this domain. POST body: ``{"name": "ns1", "ip": "1.2.3.4", "ip2": ""}``.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain
 @return ApiDomainDomainDnsCreateRequest
*/
func (a *DomainAPIService) DomainDomainDnsCreate(ctx context.Context, domain string) ApiDomainDomainDnsCreateRequest {
	return ApiDomainDomainDnsCreateRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
// Execute executes the request
//  @return DNSGlue
func (a *DomainAPIService) DomainDomainDnsCreateExecute(r ApiDomainDomainDnsCreateRequest) (*DNSGlue, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DNSGlue
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainDnsCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/domain/domain/{domain}/dns/"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterValueToString(r.domain, "domain")), -1)
...
type ApiDomainDomainDnsDestroyRequest struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
	name string
...
func (r ApiDomainDomainDnsDestroyRequest) Execute() (*http.Response, error) {
	return r.ApiService.DomainDomainDnsDestroyExecute(r)
}

/*
DomainDomainDnsDestroy Method for DomainDomainDnsDestroy
...
host at the registrar).
 ...
 @param domain
 @param name
 @return ApiDomainDomainDnsDestroyRequest
*/
func (a *DomainAPIService) DomainDomainDnsDestroy(ctx context.Context, domain string, name string) ApiDomainDomainDnsDestroyRequest {
	return ApiDomainDomainDnsDestroyRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
// Execute executes the request
func (a *DomainAPIService) DomainDomainDnsDestroyExecute(r ApiDomainDomainDnsDestroyRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainDnsDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/domain/domain/{domain}/dns/{name}/"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterValueToString(r.domain, "domain")), -1)
...
type ApiDomainDomainDnsListRequest struct {
	ctx context.Context
	ApiService *DomainAPIService
	domain string
	page *int32
...
func (r ApiDomainDomainDnsListRequest) Page(page int32) ApiDomainDomainDnsListRequest {
	r.page = &page
	return r
}

func (r ApiDomainDomainDnsListRequest) Execute() (*PaginatedDNSGlueList, *http.Response, error) {
	return r.ApiService.DomainDomainDnsListExecute(r)
}

/*
DomainDomainDnsList Method for DomainDomainDnsList
...
for this domain. POST body: ``{"name": "ns1", "ip": "1.2.3.4", "ip2": ""}``.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain
 @return ApiDomainDomainDnsListRequest
*/
func (a *DomainAPIService) DomainDomainDnsList(ctx context.Context, domain string) ApiDomainDomainDnsListRequest {
	return ApiDomainDomainDnsListRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
func (a *DomainAPIService) DomainDomainDnsListExecute(r ApiDomainDomainDnsListRequest) (*PaginatedDNSGlueList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedDNSGlueList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.DomainDomainDnsList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
