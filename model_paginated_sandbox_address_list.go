...
// checks if the PaginatedSandboxAddressList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedSandboxAddressList{}

// PaginatedSandboxAddressList struct for PaginatedSandboxAddressList
type PaginatedSandboxAddressList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []SandboxAddress `json:"results"`
}

type _PaginatedSandboxAddressList PaginatedSandboxAddressList
...
func NewPaginatedSandboxAddressList(count int32, results []SandboxAddress) *PaginatedSandboxAddressList {
	this := PaginatedSandboxAddressList{}
	this.Count = count
...
func (o *PaginatedSandboxAddressList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedSandboxAddressList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedSandboxAddressList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedSandboxAddressList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedSandboxAddressList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSandboxAddressList := _PaginatedSandboxAddressList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varPaginatedSandboxAddressList)

	if err != nil {
		return err
	}

	*o = PaginatedSandboxAddressList(varPaginatedSandboxAddressList)

	return err
}

type NullablePaginatedSandboxAddressList struct {
	value *PaginatedSandboxAddressList
	isSet bool
}

func (v NullablePaginatedSandboxAddressList) Get() *PaginatedSandboxAddressList {
	return v.value
}

func (v *NullablePaginatedSandboxAddressList) Set(val *PaginatedSandboxAddressList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedSandboxAddressList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedSandboxAddressList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedSandboxAddressList(val *PaginatedSandboxAddressList) *NullablePaginatedSandboxAddressList {
	return &NullablePaginatedSandboxAddressList{value: val, isSet: true}
}

func (v NullablePaginatedSandboxAddressList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedSandboxAddressList) UnmarshalJSON(src []byte) error {
	v.isSet = true
