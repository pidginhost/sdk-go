...
type PatchedDomain struct {
	...
	// Service status
	ServiceStatus NullableString `json:"service_status,omitempty"`
...
// SetService gets a reference to the given NullableService and assigns it to the Service field.
func (o *PatchedDomain) SetService(v Service) {
	o.Service.Set(&v)
}
// SetServiceNil sets the value for Service to be an explicit nil
func (o *PatchedDomain) SetServiceNil() {
	o.Service.Set(nil)
}
...
// GetServiceStatus returns the ServiceStatus field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedDomain) GetServiceStatus() string {
	if o == nil || IsNil(o.ServiceStatus.Get()) {
		var ret string
		return ret
	}
...
func (o *PatchedDomain) HasServiceStatus() bool {
	if o != nil && o.ServiceStatus.IsSet() {
		return true
	}
...
// SetServiceStatus gets a reference to the given NullableString and assigns it to the ServiceStatus field.
...
func (o *PatchedDomain) SetServiceStatusNil() {
	o.ServiceStatus.Set(nil)
}
...
func (o PatchedDomain) ToMap() (map[string]interface{}, error) {
	...
	if o.ServiceStatus.IsSet() {
		toSerialize["service_status"] = o.ServiceStatus.Get()
	}
	if o.Contacts != nil {
